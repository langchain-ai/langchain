...
class GrobidSplitter:
    def __init__(self, file_path: str, xml_data: str, segment_sentences: bool):
        """Create a new GrobidSplitter.

        Args:
            file_path: File path
            xml_data: xml generated from GrobidLoader
            segment_sentences: Flag to indicate whether we want sentences or paragraphs
        """
    ...
    def split_text(self) -> Iterator[Document]:
        """Split the document."""
            ...
            if sect is not None:
                for i, paragraph in enumerate(section.find_all("p")):
                    ...
                    for i, sentence in enumerate(paragraph.find_all("s")):
                        ...
                        if self.segment_sentences is True:
                    ...
                    if self.segment_sentences is not True:
                        fpage, lpage = (
