...
class FreeStyleTool(BaseTool):
    """Tool allowing Spark SQL Agent to answer by itself."""

    name = "free_style"
    description = """
    Input is not needed for this tool. Output is a statement which allows AI to generate
    the answer when AI has the confidence.
    AI should NOT use this tool when it does NOT have confidence of the answer.
    AI should ONLY use the tool when the answer CANNOT be answered by other provided tools.
    """
    ...
    def _run(
        ...
        """Return a statement which allows the AI to generate the answer by itself."""
        return "AI is allowed to generate the answer when it has the confidence."
