...
_LIST_ASSERTIONS_TEMPLATE = _("""Here is a statement:
{statement}
...
_CHECK_ASSERTIONS_TEMPLATE = _("""Here is a bullet point list of assertions:
{assertions}
...
_REVISED_ANSWER_TEMPLATE = _("""{checked_assertions}
