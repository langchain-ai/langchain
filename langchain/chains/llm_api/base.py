...
class LLMAPIChain(Chain, BaseModel):
    ...
    def api_docs(self, question: str = None):
        """builds the api docs"""
    ...
    def generate_markdown_docs_from(self, url, filename=None):
        path = f"/tmp/{filename}"
    ...
    def get_api_docs_from_open_api_url(self, open_api_url, question):
    ...
    def get_api_docs_from_url(self, documentation_urls, question):
...
DO NOT generate the same JSON object as above. Try changing some of the parameters! Don't use the same request parameters as above!"""
        ...
        self.last_successful_request = request_params_json
