...
_ASSISTANT_AGENT_REFLECTION_TEMPLATE = (
    ...
    "Now you will undergo Agent Reflection: [You will provide a Critique of the hypothetical response, highlighting the limitations, inaccuracies, or areas that need improvement or expansion, while providing guidance on how to address these issues in the revised response]"
    "You: "
)
