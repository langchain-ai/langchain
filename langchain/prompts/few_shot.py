from langchain.prompts.base import BasePromptTemplate, DEFAULT_FORMATTER_MAPPING, check_valid_template
...
class FewShotPromptTemplate(BasePromptTemplate, BaseModel):
    ...
    def template_is_valid(cls, values: Dict) -> Dict:
        ...
        check_valid_template(values["prefix"] + values["suffix"], values["template_format"], values["input_variables"])
        return values
