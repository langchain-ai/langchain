...
from sqlalchemy import Table, Column, String, REAL
...
class AnalyticDB(VectorStore):
    ...
    def create_table_if_not_exists(self) -> None:
        ...
        """)
        result = self._conn.execute(index_query).scalar()
        ...
        if not result:
            ...
            """)
            self._conn.execute(index_statement)
        self._conn.commit()
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        # Insert data into the table using execute()
    ...
    def similarity_search_with_score_by_vector(
        ...
        results: Sequence[Row] = self._conn.execute(text(sql_query), params).fetchall()
        self._conn.commit()
