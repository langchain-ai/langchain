...
class USearch(VectorStore):
    ...
    def similarity_search_with_score(
        ...
        matches, distances, _ = self.index.search(np.array(query_embedding), k)

        docs_with_scores: List[Tuple[Document, float]] = []
        for id, score in zip(matches, distances):
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        """
        query_embedding = self.embedding_function(query)
        matches, _, _ = self.index.search(np.array(query_embedding), k)
