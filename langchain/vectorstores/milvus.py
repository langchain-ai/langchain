...
class Milvus(VectorStore):
    ...
    def add_texts(
        ...
        Args:
            ...
            **kwargs: Insert arguments that pertain to milvus.

        Returns:
            List[str]: The resulting keys for each inserted element.
        """
        insert_dict: Any = {}
        insert_dict[self.text_field] = list(texts)
        try:
            insert_dict[self.vector_field] = self.embedding_func.embed_documents(
                                                                        list(texts))
        except NotImplementedError:
            insert_dict[self.vector_field] = [self.embedding_func.embed_query(x)
                                                                    for x in texts]
        ...
        # Flush to make sure newly inserted is immidiately searchable.
        self.col.flush()
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any
        ...
        """Perform a search and return results that are reoreded by MMR.
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        """Creates a Milvus collection, indexes it with HNSW, and inserts
        the data.
