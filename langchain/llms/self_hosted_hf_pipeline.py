...
class SelfHostedHuggingFacePipeline(LLM, BaseModel):
    ...
    Example using from_model_id:
        .. code-block:: python
            ...
            hf = SelfHostedHuggingFacePipeline.from_model_id(
                model_id="google/flan-t5-large", task="text-generation"
            )
    Example passing fn that generates a pipeline (because the pipeline is not serializable):
        .. code-block:: python
            ...
            hf = SelfHostedHuggingFacePipeline.from_fn(get_pipeline)
    # TODO example sending the model over with the wire using blob.to(cluster)
    """
