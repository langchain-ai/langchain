...
class AzureChatOpenAI(ChatOpenAI):
    ...
    def _create_chat_result(self, response: Mapping[str, Any]) -> ChatResult:
        for res in response["choices"]:
            ...
            elif "message" in res and res["message"].get("content", None) is None:
                # Azure OpenAI, in some cases returns no text
                # and no "content" key in response.
                # Exact response in Azure OpenAI studio is this:
                # No text was generated by the model.
                # Model encountered a stop sequence.
                # Please modify the stop sequences to improve the response.
                # But it is misleading, as there is no stop sequence in this case.
