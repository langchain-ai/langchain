...
class SerpAPIWrapper(BaseModel):
    ...
    def _process_response(res: dict) -> str:
        ...
        toret = (
            ...
            or res.get("answer_box").get("snippet_highlighted_words")[0]
            or res.get("sports_results").get("game_spotlight")
            or res.get("knowledge_graph").get("description")
            or res.get("organic_results")[0].get("snippet")
            or "No good search result found"
        )
        return toret
