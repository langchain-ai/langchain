...
class RDFGraph:
    ...
    def __init__(
        ...
        try:
            ...
            from SPARQLWrapper import BASIC, DIGEST, JSON, POST, RDFXML, SPARQLWrapper
        except ImportError:
            raise ValueError(
        ...
        if source is None:
            ...
            class ExternalGraph:
                ...
                def query(self, query: str) -> Dict[str, Any]:
                    ...
                    if query_type == "CONSTRUCT":
                        ...
                        return Graph().parse(
                            data=self.wrapper.query().response.read(), format="xml"
                        )
            ...
            try:
                ...
                raise ValueError(
                    f"Could not connect to external RDF store {source}: {e}"
                )
        else:
