...
POWERBI_PREFIX = _("""You are an agent designed to help users interact with a PowerBI Dataset.
...
POWERBI_CHAT_PREFIX = _("""Assistant is a large language model built to help users interact with a PowerBI Dataset.
