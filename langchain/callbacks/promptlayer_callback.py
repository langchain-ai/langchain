...
openai_llm = OpenAI(
    ...
    callbacks=[
        PromptLayerHandler(request_id_func=request_id_func, pl_tags=["OPENAI WORKS!"])
    ],
)
...
replicate_llm = Replicate(
    ...
    callbacks=[
        PromptLayerHandler(
            request_id_func=request_id_func, pl_tags=["REPLICATE WORKS!"]
        )
    ],
)
...
chat_llm = ChatOpenAI(
    ...
    callbacks=[
        PromptLayerHandler(
            request_id_func=request_id_func, pl_tags=["OpenAIChat WORKS!"]
        )
    ],
)
