...
class AirbyteHubspotLoader(AirbyteCDKLoader):
    def __init__(
        ...
        source_class = guard_import("source_hubspot", "airbyte-source-hubspot").SourceHubspot
        super().__init__(
            config=config,
...
class AirbyteStripeLoader(AirbyteCDKLoader):
    def __init__(
        ...
        source_class = guard_import("source_stripe", "airbyte-source-stripe").SourceStripe
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
...
class AirbyteTypeformLoader(AirbyteCDKLoader):
    def __init__(
        ...
        source_class = guard_import("source_typeform", "airbyte-source-typeform").SourceTypeform
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
...
class AirbyteZendeskSupportLoader(AirbyteCDKLoader):
    def __init__(
        ...
        source_class = guard_import("source_zendesk_support", "airbyte-source-zendesk-support").SourceZendeskSupport
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
...
class AirbyteShopifyLoader(AirbyteCDKLoader):
    def __init__(
        ...
        source_class = guard_import("source_shopify", "airbyte-source-shopify").SourceShopify
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
...
class AirbyteSalesforceLoader(AirbyteCDKLoader):
    def __init__(
        ...
        source_class = guard_import("source_salesforce", "airbyte-source-salesforce").SourceSalesforce
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
