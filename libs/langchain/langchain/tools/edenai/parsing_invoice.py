...
class EdenAiParsingInvoice(EdenaiTool):
    ...
    for api reference check edenai documentation: https://docs.edenai.co/reference/ocr_invoice_parser_create.
    ...
    description = (
        ...
        """Useful for when you have to extract information from an image it enables to take invoices 
        in a variety of formats and returns the data in contains (items, prices, addresses, vendor name, etc.)
    ...
    def _run(
        ...
        try:
            ...
            return self._format_invoice_parsing(image_analysis_result)
