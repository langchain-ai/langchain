...
class TensorflowDatasets(BaseModel):
    ...
    Current implementation can work only with datasets that fit in a memory.
    ...
    You have to provide the sample_to_document_function: a function that converts a sample
     from the dataset-specific format to the Document.
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if values["sample_to_document_function"] is None:
            raise ValueError(
                ...
                "Please provide a function that converts a dataset sample to a Document."  # noqa: E501
            )
    ...
    def load(self) -> List[Document]:
        ...
        """  # noqa: E501
        return [d for d in self.lazy_load()]
