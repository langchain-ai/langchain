...
class BaseOCILLM(LLM, Serializable):
    ...
    def validate_environment(  # pylint: disable=no-self-argument
        ...
        cls.auth = values.get("auth", default_signer())
...
class OCIModelDeploymentTGI(OCIModelDeploymentLLM):
    ...
    To authenticate, `oracle-ads` has been used to automatically load credentials:
    https://accelerated-data-science.readthedocs.io/en/latest/user_guide/cli/authentication.html

    Make sure to have the required policies to access the OCI Data Science Model Deployment endpoint.
    See: https://docs.oracle.com/en-us/iaas/data-science/using/model-dep-policies-auth.htm#model_dep_policies_auth__predict-endpoint
    ...
    watermark = True
    """Watermarking with `A Watermark for Large Language Models <https://arxiv.org/abs/2301.10226>`_. Defaults to True."""
