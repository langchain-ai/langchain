...
class Vectara(VectorStore):
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        # * when metadatas[] are provided they are associated with each "part" in Vectara. 
        #   doc_metadata can be used to provide additional metadata for the document itself 
        #   (applies to all "texts" in this call)
