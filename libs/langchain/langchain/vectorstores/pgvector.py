...
class PGVector(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        engine: Optional[Union[sqlalchemy.engine.Engine, AsyncEngine]] = None,
        ...
        if async_mode and self.engine is None:
            self.engine = create_async_engine(
                url=self.connection_string, **(self.engine_args or {})
            )

        if async_mode and isinstance(self.engine, AsyncEngine):
    ...
    async def asimilarity_search(
        ...
        **kwargs: Any,
        ...
        Returns:
            List of Documents most similar to the query.
        """
        embedding = await self.embedding_function.aembed_query(text=query)
    ...
    def __query_collection(
        ...
        with Session(self._conn) as session:
            ...
            results: List[Any] = (
                ...
                .filter(filter_by)
                .order_by(sqlalchemy.asc(sqlalchemy.text("distance")))
                .join(
