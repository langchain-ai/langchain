...
class BaseModeration:
    ...
    def moderate(self, prompt: Any) -> str:
        ...
        try:
        ...
        except BaseModerationError as e:
            self._log_message_for_verbose(
                f"The prompt failed moderation validation checks..stopping..\n"
            )
            raise e
            ...
            self._log_message_for_verbose(f"Found Toxic content..stopping..\n")
            raise e
        except ModerationIntentionError as e:
            self._log_message_for_verbose(f"Found Harmful intention..stopping..\n")
            raise e
