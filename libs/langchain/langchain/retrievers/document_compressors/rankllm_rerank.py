...
from langchain_core.pydantic_v1 import Field, PrivateAttr, Extra, root_validator
        ...
        if not values.get("client"):
            ...
            try:
                if model_enum == ModelType.VICUNA:
                    ...
                    agent = SafeOpenai(model=values["gpt_model"], context_size=4096, keys=llm.openai_api_key)
