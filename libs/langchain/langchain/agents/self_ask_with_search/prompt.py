...
_DEFAULT_TEMPLATE = """Question: Кто прожил дольше, Мухаммед Али или Алан Тьюринг?
...
Question: Кто был материнским дедом Джорджа Вашингтона?
Нужны ли здесь дополнительные вопросы: Да.
...
Question: Оба ли режиссера фильмов "Челюсти" и "Казино Рояль" из одной страны?
Нужны ли здесь дополнительные вопросы: Да.
