...
from typing import Any, List, Sequence, Tuple, Type, Union, Dict, Callable
...
def create_cohere_tools_agent(
    ...
    agent = (
        RunnablePassthrough.assign(
            ...
            input= lambda x: prompt.format_messages(input=x["input"], agent_scratchpad=""),
...
def format_to_cohere_tools(
    ...
    if len(intermediate_steps) == 1 and intermediate_steps[0][0].tool == "directly_answer":
        return None
