...
Вопрос: {input}
Мысль: Я могу сначала спросить, какие у меня есть таблицы, затем как каждая таблица определена, затем задать инструменту запрос, который мне нужен, и, наконец, создать хорошее предложение, которое отвечает на вопрос.
{agent_scratchpad}"""
