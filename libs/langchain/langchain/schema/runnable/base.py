...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    def transform(
        ...
        **kwargs: Any,
        ...
        return transform_stream_with_config(input, self._transform, config, **kwargs)
    ...
    def atransform(
        ...
        **kwargs: Any,
        ...
        return atransform_stream_with_config(input, self._atransform, config, **kwargs)
...
class RunnableEach(RunnableSerializable[List[Input], List[Output]]):
    ...
    def invoke(
        ...
        return call_with_config(self._invoke, input, config)
