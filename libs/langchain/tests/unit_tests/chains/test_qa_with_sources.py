...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            (
                "The president did not mention Michael Jackson in the provided "
                "content.\n"
                "SOURCES: \n\n"
                "Note: Since the content provided does not contain any information "
                "about Michael Jackson, there are no sources to cite for this specific "
                "question."
            ),
        ...
        (
            (
                "To diagnose the problem, please answer the following questions and "
                "send them in one message to IT:\n"
                ...
                "SOURCES: 1\n\n"
                "ALTERNATIVE OPTION: Another option is to run the VPN in CLI, but keep "
                "in mind that DNS settings may not work and there may be a need for "
                "manual modification of the local resolver or /etc/hosts and/or "
                "~/.ssh/config files to be able to connect to machines in the company. "
                "With the appropriate packages installed, the only thing needed to "
                "establish a connection is to run the command:\n"
                ...
                "SOURCES: 2\n\n"
                "ALTERNATIVE OPTION (for Windows): Download the OpenVPN client "
                "application version 2.6 or newer from the official website: "
