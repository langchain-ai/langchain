...
with patch.dict('sys.modules', {
    ...
    class MockAnchorContentTool:
        ...
        def run(self, args: Dict[str, Any]) -> str:
            return f"Content from {args.get('url', 'unknown')} in {args.get('format', 'markdown')} format"
    ...
    class MockAnchorScreenshotTool:
        ...
        def run(self, args: Dict[str, Any]) -> str:
            return f"Screenshot of {args.get('url', 'unknown')} at {args.get('width', 1920)}x{args.get('height', 1080)}"
    ...
    class MockSimpleAnchorWebTaskTool:
        ...
        def run(self, args: Dict[str, Any]) -> str:
            return f"Completed task: {args.get('prompt', 'unknown')} on {args.get('url', 'unknown')}"
