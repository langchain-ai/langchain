...
def test_invoke() -> None:
    documents1 = [Document(page_content = "a", metadata = {"id": 1}),
    ...
    ensemble_retriever = EnsembleRetriever(retrievers = [retriever1, retriever2], id_key = None)
    ...
    ensemble_retriever = EnsembleRetriever(retrievers = [retriever1, retriever2], id_key = "id")
    ranked_documents = ensemble_retriever.invoke("_")
