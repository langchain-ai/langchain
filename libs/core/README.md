...
![Diagram showing the hierarchical organization of the LangChain framework with components like LangSmith, LangServe, Templates, LangChain, LangChain-Community, and LangChain-Core.](../../docs/static/img/langchain_stack.png "LangChain Framework Diagram")
