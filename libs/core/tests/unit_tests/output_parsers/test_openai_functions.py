...
def test_json_output_function_parser_strictness(config: Dict[str, Any]) -> None:
    ...
    message = AIMessage(
        content="This is a test message",
        data={"function_call": {"name": "function_name", "arguments": args}},
    )
    chat_generation = ChatGeneration(message=message)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        AIMessage(content="This is a test message", data={}),
        # Bad function call information (arguments should be a string)
        AIMessage(
            content="This is a test message",
            data={"function_call": {"name": "function_name", "arguments": {}}},
        ),
        # Bad function call information (arguments should be proper json)
        AIMessage(
            content="This is a test message",
            data={"function_call": {"name": "function_name", "arguments": "noqweqwe"}},
        ),
    ],
)
