...
def test_convert_to_openai_messages_reasoning_content() -> None:
    ...
    msg_with_summary = AIMessage(content=[
        {'type': 'reasoning', 'summary': [
            {'type': 'text', 'text': 'First thought'},
            {'type': 'text', 'text': 'Second thought'}
        ]}
    ])
    result_with_summary = convert_to_openai_messages(msg_with_summary, text_format="block")
    ...
    mixed_msg = AIMessage(content=[
        {'type': 'text', 'text': 'Regular response'},
        {'type': 'reasoning', 'summary': [
            {'type': 'text', 'text': 'My reasoning process'}
        ]}
    ])
