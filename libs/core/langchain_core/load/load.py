    ...
    def __init__(
        ...
        Args:
            ...
            secrets_from_env: Whether to load secrets from the environment.
                Defaults to True.
            additional_import_mappings: A dictionary with mappings for additional namespaces. You can use this to
                override default mappings or add additional mappings for your own classes that may have changed.
                Defaults to None.
        """
