...
class StructuredTool(BaseTool):
    ...
    def _injected_args_keys(self) -> frozenset[str]:
        ...
        # so `InjectedToolArg` markers survive resolution. Fall back to the raw
        # per-parameter annotation when a hint can't be resolved. Mirrors
        # `BaseTool._injected_args_keys` in `base.py`.
