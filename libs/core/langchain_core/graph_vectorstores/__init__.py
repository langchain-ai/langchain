...
Several common link extractors are available and you can build your own. For this guide,
 we'll use the KeybertLinkExtractor which uses the KeyBERT model to tag documents with
keywords and uses these keywords to create links between documents.
...
The similarity search method returns documents similar to a query without considering
...
The traversal search method returns documents similar to a query considering the links
