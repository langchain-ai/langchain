...
class Citation(TypedDict):
    ...
    .. note::
        ``create_citation`` is the preferred way to create
        ``Citation``s as it:
...
class TextContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_text_block`` is the preferred way to create
        ``TextContentBlock``s as it:
...
class ToolCall(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_tool_call`` is the preferred way to create
        ``ToolCall``s as it:
...
class ReasoningContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_reasoning_block`` is the preferred way to create
        ``ReasoningContentBlock``s as it:
...
class ImageContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_image_block`` is the preferred way to create
        ``ImageContentBlock``s as it:
...
class VideoContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_video_block`` is the preferred way to create
        ``VideoContentBlock``s as it:
...
class AudioContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_audio_block`` is the preferred way to create
        ``AudioContentBlock``s as it:
...
class PlainTextContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_plaintext_block`` is the preferred way to create
        ``PlainTextContentBlock``s as it:
...
class FileContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_file_block`` is the preferred way to create
        ``FileContentBlock``s as it:
...
class NonStandardContentBlock(TypedDict):  # type: ignore[call-arg]
    ...
    .. note::
        ``create_non_standard_block`` is the preferred way to create
