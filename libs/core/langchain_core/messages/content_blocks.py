...
def _generate_fallback_filename(mime_type: str) -> Union[str, None]:
    ...
    if block["type"] == "image":
        ...
        if block["source_type"] == "base64":
            ...
            if filename := block.get("filename"):
                ...
                warnings.warn(
                    "OpenAI may require a filename for file inputs. "
                    "Generating a fallback, but "
                    "you may also specify a filename "
                ...
                if mime_type is None or not isinstance(mime_type, str):
                    err = f"Invalid mime_type: {mime_type}. Must be a string."
