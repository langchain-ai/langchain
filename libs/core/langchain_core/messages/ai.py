...
class InputTokenDetails(TypedDict, total=False):
    ...
    Tokens corresponding to image content supplied as input to multimodal models
    (e.g. vision models that accept image inputs).
    """
...
class OutputTokenDetails(TypedDict, total=False):
    ...
    Tokens corresponding to image content generated by image generation models
    (e.g. Gemini image generation). Surfacing this allows LangSmith and other
    tooling to account for per-modality token costs.
    """
