...
class BaseOutputParser(
    ...
    def __init__(self, history_size: int = 3, *args, **kwargs):
    ...
    def update_and_check_repetition(self, output_text: str) -> bool:
        ...
        Args:
            output_text (str): The current output generated by the agent.
        ...
        if (
            len(reasoning_history) > 1
            and reasoning_history[-1] == reasoning_history[-2] == output_text
        ):
            return True
