...
from langchain_integrations.chains.openai_functions import create_tagging_chain
...
class OpenAIMetadataTagger(BaseDocumentTransformer, BaseModel):
    ...
    Example:
        .. code-block:: python
                ...
                from langchain_integrations.document_transformers import OpenAIMetadataTagger
    ...
    *,
    ...
    Example:
        .. code-block:: python
                ...
                from langchain_integrations.chat_models import ChatOpenAI
                from langchain_integrations.document_transformers import create_metadata_tagger
                from langchain_core.documents import Document
