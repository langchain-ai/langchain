...
from langchain_integrations.chat_models.base import SimpleChatModel
from langchain_integrations.llms.azureml_endpoint import AzureMLEndpointClient, ContentFormatterBase
