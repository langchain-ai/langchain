...
from langchain_integrations.adapters.openai import convert_dict_to_message, convert_message_to_dict
...
class ChatKonko(BaseChatModel):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_integrations.chat_models import ChatKonko
