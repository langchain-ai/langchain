...
from langchain_integrations.llms.sagemaker_endpoint import ContentHandlerBase
...
class SagemakerEndpointEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_integrations.embeddings import SagemakerEndpointEmbeddings
            endpoint_name = (
                "my-endpoint-name"
            )
            region_name = (
