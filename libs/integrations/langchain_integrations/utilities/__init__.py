...
from langchain_integrations.utilities.requests import Requests, RequestsWrapper, TextRequestsWrapper


def _import_alpha_vantage() -> Any:
    from langchain_integrations.utilities.alpha_vantage import AlphaVantageAPIWrapper

    return AlphaVantageAPIWrapper


def _import_apify() -> Any:
    from langchain_integrations.utilities.apify import ApifyWrapper

    return ApifyWrapper


def _import_arcee() -> Any:
    from langchain_integrations.utilities.arcee import ArceeWrapper

    return ArceeWrapper


def _import_arxiv() -> Any:
    from langchain_integrations.utilities.arxiv import ArxivAPIWrapper

    return ArxivAPIWrapper


def _import_awslambda() -> Any:
    from langchain_integrations.utilities.awslambda import LambdaWrapper

    return LambdaWrapper


def _import_bibtex() -> Any:
    from langchain_integrations.utilities.bibtex import BibtexparserWrapper

    return BibtexparserWrapper


def _import_bing_search() -> Any:
    from langchain_integrations.utilities.bing_search import BingSearchAPIWrapper

    return BingSearchAPIWrapper


def _import_brave_search() -> Any:
    from langchain_integrations.utilities.brave_search import BraveSearchWrapper
...
def _import_golden_query() -> Any:
    from langchain_integrations.utilities.golden_query import GoldenQueryAPIWrapper

    return GoldenQueryAPIWrapper


def _import_google_lens() -> Any:
    from langchain_integrations.utilities.google_lens import GoogleLensAPIWrapper

    return GoogleLensAPIWrapper


def _import_google_places_api() -> Any:
    from langchain_integrations.utilities.google_places_api import GooglePlacesAPIWrapper

    return GooglePlacesAPIWrapper


def _import_google_jobs() -> Any:
    from langchain_integrations.utilities.google_jobs import GoogleJobsAPIWrapper

    return GoogleJobsAPIWrapper


def _import_google_scholar() -> Any:
    from langchain_integrations.utilities.google_scholar import GoogleScholarAPIWrapper

    return GoogleScholarAPIWrapper


def _import_google_trends() -> Any:
    from langchain_integrations.utilities.google_trends import GoogleTrendsAPIWrapper

    return GoogleTrendsAPIWrapper


def _import_google_finance() -> Any:
    from langchain_integrations.utilities.google_finance import GoogleFinanceAPIWrapper

    return GoogleFinanceAPIWrapper


def _import_google_search() -> Any:
    from langchain_integrations.utilities.google_search import GoogleSearchAPIWrapper

    return GoogleSearchAPIWrapper


def _import_google_serper() -> Any:
    from langchain_integrations.utilities.google_serper import GoogleSerperAPIWrapper

    return GoogleSerperAPIWrapper


def _import_graphql() -> Any:
    from langchain_integrations.utilities.graphql import GraphQLAPIWrapper
...
def _import_max_compute() -> Any:
    from langchain_integrations.utilities.max_compute import MaxComputeAPIWrapper

    return MaxComputeAPIWrapper


def _import_merriam_webster() -> Any:
    from langchain_integrations.utilities.merriam_webster import MerriamWebsterAPIWrapper

    return MerriamWebsterAPIWrapper


def _import_metaphor_search() -> Any:
    from langchain_integrations.utilities.metaphor_search import MetaphorSearchAPIWrapper

    return MetaphorSearchAPIWrapper


def _import_openweathermap() -> Any:
    from langchain_integrations.utilities.openweathermap import OpenWeatherMapAPIWrapper

    return OpenWeatherMapAPIWrapper


def _import_outline() -> Any:
    from langchain_integrations.utilities.outline import OutlineAPIWrapper

    return OutlineAPIWrapper


def _import_portkey() -> Any:
    from langchain_integrations.utilities.portkey import Portkey
...
def _import_pubmed() -> Any:
    from langchain_integrations.utilities.pubmed import PubMedAPIWrapper

    return PubMedAPIWrapper


def _import_python() -> Any:
    from langchain_integrations.utilities.python import PythonREPL

    return PythonREPL


def _import_scenexplain() -> Any:
    from langchain_integrations.utilities.scenexplain import SceneXplainAPIWrapper

    return SceneXplainAPIWrapper


def _import_searchapi() -> Any:
    from langchain_integrations.utilities.searchapi import SearchApiAPIWrapper

    return SearchApiAPIWrapper


def _import_searx_search() -> Any:
    from langchain_integrations.utilities.searx_search import SearxSearchWrapper

    return SearxSearchWrapper


def _import_serpapi() -> Any:
    from langchain_integrations.utilities.serpapi import SerpAPIWrapper
...
def _import_stackexchange() -> Any:
    from langchain_integrations.utilities.stackexchange import StackExchangeAPIWrapper

    return StackExchangeAPIWrapper


def _import_tensorflow_datasets() -> Any:
    from langchain_integrations.utilities.tensorflow_datasets import TensorflowDatasets

    return TensorflowDatasets


def _import_twilio() -> Any:
    from langchain_integrations.utilities.twilio import TwilioAPIWrapper
...
def _import_wolfram_alpha() -> Any:
    from langchain_integrations.utilities.wolfram_alpha import WolframAlphaAPIWrapper
