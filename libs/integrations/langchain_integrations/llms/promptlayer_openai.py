...
from langchain_openai.llm import OpenAI, OpenAIChat
...
class PromptLayerOpenAI(OpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_integrations.llms import PromptLayerOpenAI
...
class PromptLayerOpenAIChat(OpenAIChat):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_integrations.llms import PromptLayerOpenAIChat
