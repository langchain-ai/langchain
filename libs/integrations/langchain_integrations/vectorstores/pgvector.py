...
if TYPE_CHECKING:
    from langchain_integrations.vectorstores._pgvector_data_models import CollectionStore
...
class PGVector(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_integrations.vectorstores import PGVector
    ...
    def __post_init__(
        ...
        from langchain_integrations.vectorstores._pgvector_data_models import (
            CollectionStore,
            EmbeddingStore,
        )
