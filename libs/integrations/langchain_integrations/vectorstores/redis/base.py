...
from langchain_integrations.utilities.redis import (
    _array_to_buffer,
    _buffer_to_array,
...
from langchain_integrations.vectorstores.redis.constants import (
    REDIS_REQUIRED_MODULES,
    REDIS_TAG_SEPARATOR,
)
from langchain_integrations.vectorstores.utils import maximal_marginal_relevance
...
class Redis(VectorStore):
    ...
    .. code-block:: python
        ...
        from langchain_integrations.vectorstores import Redis
        from langchain_integrations.embeddings import OpenAIEmbeddings
    ...
    def _get_schema_with_defaults(
        ...
        from langchain_integrations.vectorstores.redis.schema import RedisModel, read_schema
