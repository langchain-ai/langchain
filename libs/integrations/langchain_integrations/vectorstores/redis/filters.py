...
class RedisTag(RedisFilterField):
    ...
    def __eq__(
        ...
        Example:
            >>> from langchain_integrations.vectorstores.redis import RedisTag
...
class RedisNum(RedisFilterField):
    ...
    def __eq__(self, other: Union[int, float]) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchain_integrations.vectorstores.redis import RedisNum
...
class RedisText(RedisFilterField):
    ...
    def __eq__(self, other: str) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchain_integrations.vectorstores.redis import RedisText
...
class RedisFilterExpression:
    ...
    Examples:
        ...
        >>> from langchain_integrations.vectorstores.redis import RedisTag, RedisNum
