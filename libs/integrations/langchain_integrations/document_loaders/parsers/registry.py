...
from langchain_integrations.document_loaders.parsers.msword import MsWordParser
from langchain_integrations.document_loaders.parsers.pdf import PyMuPDFParser
from langchain_integrations.document_loaders.parsers.txt import TextParser
