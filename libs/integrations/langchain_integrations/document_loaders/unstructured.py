...
class UnstructuredFileLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from langchain_integrations.document_loaders import UnstructuredFileLoader
...
class UnstructuredAPIFileLoader(UnstructuredFileLoader):
    ...
    Examples
    ```python
    from langchain_integrations.document_loaders import UnstructuredAPIFileLoader
...
class UnstructuredFileIOLoader(UnstructuredBaseLoader):
    ...
    Examples
    --------
    from langchain_integrations.document_loaders import UnstructuredFileIOLoader
