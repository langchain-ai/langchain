...
class ChatModelIntegrationTests(ChatModelTests):
    ...
    .. dropdown:: enable_vcr_tests
        ...
        `VCR <https://vcrpy.readthedocs.io/en/latest/>`__ caching of HTTP calls, such
    ...
    def test_structured_few_shot_examples(
        ...
        .. dropdown:: Troubleshooting
            ...
            sequence of messages representing "few-shot" `examples <https://python.langchain.com/api_reference/core/utils/langchain_core.utils.function_calling.tool_example_to_messages.html/>`__.
    ...
    def test_json_mode(self, model: BaseChatModel) -> None:
        """Test structured output via `JSON mode. <https://python.langchain.com/docs/concepts/structured_outputs/#json-mode>`__
