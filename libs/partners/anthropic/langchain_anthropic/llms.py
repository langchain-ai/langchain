...
class AnthropicLLM(LLM, _AnthropicCommon):
    ...
    To use, you should have the  python packages  ``anthropic`` and ``langchain-anthropic`` installed, 
    and the environment variable ANTHROPIC_API_KEY set with your API key, or pass it as a named parameter
    to the constructor.
    ...
    Example:
        .. code-block:: python
            ...
            model = AnthropicLLM(model="<model_name>", anthropic_api_key="<api_key>")
