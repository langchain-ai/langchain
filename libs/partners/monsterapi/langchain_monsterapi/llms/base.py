...
class BaseOpenAI(BaseLLM):
    ...
    model_name: str = Field(default="meta-llama/Meta-Llama-3-8B-Instruct", alias="model")
    """Model name to use."""
    ...
    openai_api_base: Optional[str] = Field(default="https://llm.monsterapi.ai/v1/", alias="base_url")
