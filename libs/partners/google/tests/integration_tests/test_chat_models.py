...
async def test_integration_abatch() -> None:
    """Test streaming tokens from ChatGoogleGenerativeAIChat."""
    llm = ChatGoogleGenerativeAIChat()
...
async def test_integration_abatch_tags() -> None:
    """Test batch tokens from ChatGoogleGenerativeAIChat."""
    llm = ChatGoogleGenerativeAIChat()
...
async def test_integration_ainvoke() -> None:
    """Test invoke tokens from ChatGoogleGenerativeAIChat."""
    llm = ChatGoogleGenerativeAIChat()
