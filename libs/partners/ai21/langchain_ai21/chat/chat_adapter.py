...
from typing import Any, List, Union, cast, Dict
...
class JambaChatCompletionsAdapter(ChatAdapter):
    def convert_messages(self, messages: List[BaseMessage]) -> Dict[str, Any]:
        return {"messages": [self._convert_message_to_ai21_message(message) for message in messages]}
