...
class ExaSearchResults(BaseTool):  # type: ignore[override]
    ...
    description: str = (
        "A wrapper around Exa Search, a web search API built for AI. "
    ...
    def _run(
        ...
        type: Literal["auto", "neural", "keyword"] | None = None,  # noqa: A002
        ...
        Args:
            ...
            type: The type of search, 'auto', 'neural', or 'keyword'.
