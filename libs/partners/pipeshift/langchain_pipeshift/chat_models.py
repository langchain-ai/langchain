"""Pipeshift's Chat Completions API."""
...
class ChatPipeshift(BaseChatOpenAI):
    ...
    def lc_secrets(self) -> Dict[str, str]:
        ...
        For example,
            {"pipeshift_api_key": "PIPESHIFT_API_KEY"}
        """
    ...
    def get_lc_namespace(cls) -> List[str]:
        ...
        return ["langchain", "chat_models", "pipeshift"]
    ...
    def lc_attributes(self) -> Dict[str, Any]:
        ...
        if self.pipeshift_api_base:
            attributes["pipeshift_api_base"] = self.pipeshift_api_base
