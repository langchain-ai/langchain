...
`__version__` variable in `langchain_ollama/_version.py`. Intended for use as a
...
def main() -> int:
    ...
    version_path = package_dir / "langchain_ollama" / "_version.py"
    ...
    if pyproject_version != version_py_version:
        ...
        print(f"  langchain_ollama/_version.py: {version_py_version}")  # noqa: T201
        return 1
