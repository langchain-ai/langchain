...
class ChatNeo4j(BaseChatModel):
    ...
    Tool calling:
        ...
        See ``ChatNeo4j.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatNeo4j.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatNeo4j supports streaming. Otherwise delete method.
    # def _stream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatNeo4j supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatNeo4j supports async generation. Otherwise delete.
