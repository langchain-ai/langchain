...
class ChatMiniMax(BaseChatOpenAI):
    """MiniMax chat model integration to access models hosted in MiniMax's API.
    ...
    Tool calling:
        ...
        See `ChatMiniMax.bind_tools()` method for more.
    ...
    Structured output:
        ...
        See `ChatMiniMax.with_structured_output()` for more.
    ...
    def _get_request_payload(
        ...
        **kwargs: Any,
        ...
        if "temperature" in payload:
            ...
            if temp is not None:
                payload["temperature"] = max(0.01, min(float(temp), 1.0))
    ...
    def _create_chat_result(
        ...
        for generation in rtn.generations:
            ...
            generation.message.response_metadata["model_provider"] = "minimax"
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            msg = (
                "MiniMax API returned an invalid response. "
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            method: The method for steering model generation, one of:
                ...
                - `'function_calling'`:
                    Uses MiniMax's tool-calling features.
                - `'json_mode'`:
                    Uses MiniMax's JSON mode feature.
