...
def test_initialization() -> None:
    """Test the general initialization of ChatTogether"""
    ChatTogether(
        model="togethercomputer/RedPajama-INCITE-7B-Chat", together_api_key="test"
    )


def test_model_setting() -> None:
    """Test if the model name is being set correctly"""
    chat = ChatTogether(
        model="togethercomputer/RedPajama-INCITE-7B-Chat", together_api_key="test"
    )
    assert chat.model == "togethercomputer/RedPajama-INCITE-7B-Chat"
