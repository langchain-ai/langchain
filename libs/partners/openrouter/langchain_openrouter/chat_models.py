...
class ChatOpenRouter(BaseChatOpenAI):
    """OpenRouter chat model integration to access models hosted in OpenRouter's API.

    Setup:
        Install `langchain-openrouter` and set environment variable `OPENROUTER_API_KEY`.
    ...
    Key init args — completion params:
        model:
            Name of OpenRouter model to use, e.g. `"minimax/minimax-m2:free"`.
        temperature:
    ...
    Key init args — client params:
        ...
        api_key:
            OpenRouter API key. If not passed in will be read from env var `OPENROUTER_API_KEY`.
    ...
    Tool calling:
        ...
        See `ChatOpenRouter.bind_tools()` method for more.
    ...
    Structured output:
        ...
        See `ChatOpenRouter.with_structured_output()` for more.
    ...
    def _get_ls_params(
        ...
        **kwargs: Any,
        ...
        ls_params["ls_provider"] = "openrouter"
        return ls_params
        ...
        **kwargs: Any,
        ...
        for message in payload["messages"]:
            if message["role"] == "tool" and isinstance(message["content"], list):
                ...
                # OpenRouter API expects assistant content to be a string, not a list.
    ...
    def _create_chat_result(
        ...
        for generation in rtn.generations:
            ...
            generation.message.response_metadata["model_provider"] = "openrouter"
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            msg = (
                "OpenRouter API returned an invalid response. "
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            method: The method for steering model generation, one of:
                ...
                - `'function_calling'`:
                    Uses OpenRouter's [tool-calling features](https://openrouter.ai/docs).
                - `'json_mode'`:
                    Uses OpenRouter's [JSON mode feature](https://openrouter.ai/docs).
            ...
            strict:
                ...
                in accordance with the OpenAI API specification. However, the OpenRouter
