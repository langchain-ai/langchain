...
class ChatHuggingFace(BaseChatModel):
    ...
    Works with `HuggingFaceTextGenInference`, `HuggingFaceEndpoint`, `HuggingFaceHub`,
    ...
    Response metadata
        ...
        .. code-block:: python
            {'token_usage': ChatCompletionOutputUsage(completion_tokens=100, prompt_tokens=8, total_tokens=108),
             'model': '',
