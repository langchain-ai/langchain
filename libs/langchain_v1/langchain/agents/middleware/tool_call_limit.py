            ...
            if self.tool_name is None:
                artificial_messages.extend(
                    ToolMessage(
                        ...
                        name=cancelled_tool_call.get("name"),
                        status="error",
                    )
                    # tool_call from allowed_calls is actually cancelled, so we name
                    # it cancelled tool call
                    for cancelled_tool_call in allowed_calls
                )
