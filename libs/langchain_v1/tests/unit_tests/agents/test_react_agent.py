...
def test__infer_handled_types() -> None:
    ...
    def handle4(e: Union[ValueError, ToolException]) -> str:  # noqa: UP007
        return ""
    ...
    def handle6(e: Union[Union[TypeError, ValueError], ToolException]) -> str:  # noqa: UP007
        return ""
