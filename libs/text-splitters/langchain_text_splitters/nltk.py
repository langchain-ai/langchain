...
class NLTKTextSplitter(TextSplitter):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._tokenizer = nltk.tokenize._get_punkt_tokenizer(language)  # noqa: SLF001

    def _span_tokenize(self, text: str) -> list[str]:
    ...
    def split_text(self, text: str) -> list[str]:
        ...
        splits = (
            self._span_tokenize(text)
            if self._use_span_tokenize
            else self._tokenizer.tokenize(text)
        )
