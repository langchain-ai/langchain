...
class CharacterTextSplitter(TextSplitter):
    ...
    def from_huggingface_tokenizer(
        ...
        """Character Text splitter that uses HuggingFace tokenizer to count length."""
        try:
    ...
    def from_tiktoken_encoder(
        ...
        **kwargs: Any,
        ...
        """Character Text splitter that uses tiktoken encoder to count length."""
        try:
            import tiktoken
        except ImportError:
            raise ImportError(
...
class RecursiveCharacterTextSplitter(TextSplitter):
    ...
    def from_tiktoken_encoder(
        ...
        **kwargs: Any,
        ...
        """RecursiveCharacter Text splitter that uses tiktoken encoder to count length."""
        try:
            import tiktoken
        except ImportError:
            raise ImportError(
