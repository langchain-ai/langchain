...
def test_experimental_markdown_syntax_text_splitter() -> None:
    ...
    expected_output = [
        ...
        Document(
            page_content="```python\ndef func_definition():\n   print('Keep the whitespace consistent')\n```\n",
            metadata={"Code": "python", "Header 1": "My Header 1", "Header 2": "Header 2"},
        ),
        Document(
...
def test_experimental_markdown_syntax_text_splitter_split_lines() -> None:
    ...
    expected_output = [
        ...
        Document(
            page_content="Content for header 2", metadata={"Header 1": "My Header 1", "Header 2": "Header 2"}
        ),
        Document(
            page_content="```python", metadata={"Code": "python", "Header 1": "My Header 1", "Header 2": "Header 2"},
        ),
        Document(
            page_content="def func_definition():", metadata={"Code": "python", "Header 1": "My Header 1", "Header 2": "Header 2"},
        ),
        Document(
            page_content="   print('Keep the whitespace consistent')", metadata={"Code": "python", "Header 1": "My Header 1", "Header 2": "Header 2"},
        ),
        Document(
            page_content="```",
            metadata={"Code": "python", "Header 1": "My Header 1", "Header 2": "Header 2"},
