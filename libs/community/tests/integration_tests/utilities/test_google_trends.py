...
def test_unexpected_response(mocked_serpapiclient):
  ...
  resp = {
    'search_metadata': {
            ...
            'status': 'Error', 
            'json_endpoint': 'https://serpapi.com/searches/1060a69da6ea9d1a/659f32ec36e6a9107b46b5b4.json', 
            ...
            'prettify_html_file': 'https://serpapi.com/searches/1060a69da6ea9d1a/659f32ec36e6a9107b46b5b4.prettify', 
