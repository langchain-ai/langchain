...
if TYPE_CHECKING:
    ...
    from langchain_community.retrievers.asknews import AskNewsRetriever
    ...
    from langchain_community.retrievers.rememberizer import RememberizerRetriever
    ...
    from langchain_community.retrievers.zep_cloud import ZepCloudRetriever
