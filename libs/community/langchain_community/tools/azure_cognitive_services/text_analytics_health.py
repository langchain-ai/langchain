...
class AzureCogsTextAnalyticsHealthToolInput(BaseTool):
    """Input for the AzureCogsTextAnalyticsHealthToolInput."""

    query: str = Field(description="Text for Health API")
...
class AzureCogsTextAnalyticsHealthTool(BaseTool):
    ...
    args_schema: Type[BaseModel] = AzureCogsTextAnalyticsHealthToolInput
