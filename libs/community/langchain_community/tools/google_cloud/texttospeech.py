...
class GoogleCloudTextToSpeechToolInput(BaseModel):
    input_text: str = Field(
        description="Input Text that needs to be converted to audio"
    )
    language_code: str = Field(
        description="Input Text that needs to be converted to audio", default="en-US"
    )
    ssml_gender: Optional[texttospeech.SsmlVoiceGender] = Field(
        description="SSML Gender"
    )
    audio_encoding: Optional[texttospeech.AudioEncoding] = Field(
        description="AudioEncoding"
    )
...
class GoogleCloudTextToSpeechTool(BaseTool):
    ...
    _client: Any
    arg_schema: Type[
        GoogleCloudTextToSpeechToolInput
    ] = GoogleCloudTextToSpeechToolInput
