...
class FinancePolygonGainersLosersSchema(BaseModel):
    ...
    direction: str = Field(
        description="Direction of the snapshot results. Possible values are 'gainers' or 'losers'."
    )
...
class PolygonGainersLosers(BaseTool):
    ...
    args_schema: Type[FinancePolygonGainersLosersSchema] = FinancePolygonGainersLosersSchema
