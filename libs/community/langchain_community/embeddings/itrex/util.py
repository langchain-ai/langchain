...
sentence_transformers = _LazyImport("sentence_transformers")
InstructorEmbedding = _LazyImport("InstructorEmbedding")

class _OptimzedTransformer(sentence_transformers.models.Transformer):
...
class _OptimizedSentenceTransformer(sentence_transformers.SentenceTransformer):
    def __init__(self, *args, **kwargs):
    ...
    def _load_auto_model(
        ...
        transformer_model = _OptimzedTransformer(
            model_name_or_path,
...
class _OptimizedInstructorTransformer(InstructorEmbedding.INSTRUCTOR_Transformer):
    def __init__(self, *args, **kwargs):
...
class _OptimizedInstructor(InstructorEmbedding.INSTRUCTOR):
    def __init__(self, *args, **kwargs):
        ...
        for module_config in modules_config:
            ...
            if module_class == sentence_transformers.models.Transformer and module_config['path'] == "":
                ...
                if "tokenizer_args" in kwargs:
                    ...
                    kwargs["tokenizer_args"] = hub_kwargs
                module = _OptimizedInstructorTransformer(model_name_or_path, cache_dir=cache_folder, **kwargs)
