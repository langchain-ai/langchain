...
if TYPE_CHECKING:
    ...
    from langchain_community.embeddings.clova import ClovaEmbeddings
    ...
    from langchain_community.embeddings.itrex import QuantizedBgeEmbeddings
    ...
    from langchain_community.embeddings.solar import SolarEmbeddings
