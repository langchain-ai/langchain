...
@deprecated(since="0.1.0", alternative="langchain_openai.OpenAI")
...
@deprecated(since="0.1.0", alternative="langchain_openai.AzureOpenAI")
...
@deprecated(since="0.1.0", alternative="langchain_openai.ChatOpenAI")
