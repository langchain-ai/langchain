...
class BaseOpenAI(BaseLLM):
    ...
    def _invocation_params(self) -> Dict[str, Any]:
        ...
        if self.openai_proxy:
            ...
            openai.proxy = {"http": self.openai_proxy, "https": self.openai_proxy}  # type: ignore[assignment]  # type: ignore[attr-defined]
...
class OpenAIChat(BaseLLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            if openai_proxy:
                openai.proxy = {"http": openai_proxy, "https": openai_proxy}  # type: ignore[assignment]  # type: ignore[attr-defined]
        except ImportError:
            raise ImportError(
                "Could not import openai python package. "
                "Please install it with `pip install openai`."
