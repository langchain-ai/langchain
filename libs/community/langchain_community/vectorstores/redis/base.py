...
class Redis(VectorStore):
    ...
    def __init__(
        ...
        index_schema: Optional[Union[Dict[str, list[Dict[str, str]]], str, os.PathLike]] = None,
    ...
    def from_texts_return_keys(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            index_schema (Optional[Union[Dict[str, list[Dict[str, str]]], str, os.PathLike]], optional):
