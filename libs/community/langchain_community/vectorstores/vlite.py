...
class VLite(VectorStore):
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        data = [{"text": text, "metadata": metadata, "id": id} for text, metadata, id in zip(texts, metadatas, ids)]
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        documents = [Document(page_content=text, metadata=metadata) for text, _, metadata in results]
        return documents
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        documents_with_scores = [(Document(page_content=text, metadata=metadata), score) for text, score, metadata in results]
