    ...
    def __del__(self) -> None:
        ...
        if hasattr(self, "async_client") and self.async_client:
            ...
            try:
                ...
                # Handle the case where there's no event loop or asyncio is unavailable during shutdown
                try:
                    ...
                    # Skip async client cleanup if asyncio is unavailable (e.g., during Python shutdown)
                    pass
