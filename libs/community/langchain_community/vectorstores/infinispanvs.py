...
"""
    ...
    def schema_create(self, proto: str) -> Any:
    ...
    def cache_create(self, config: str = "") -> Any:
...
"""
    ...
    def cache_index_clear(self) -> Any:
    ...
    def cache_index_reindex(self) -> Any:
...
class Infinispan:
    ...
    def __init__(self, **kwargs: Any):
        ...
        self._schema_url = str(
            self._configuration.get("schema_url", "/rest/v2/schemas")
        )
        ...
        self._h2c = httpx.Client(
            ...
            auth=auth,
            verify=bool(self._configuration.get("verify")),
        )

    def req_query(self, query: str, cache_name: str, local: bool = False) -> Any:
        """Request a query
        Args:
    ...
    def _query_post(self, query_str: str, cache_name: str, local: bool = False) -> Any:
        api_url = (
            self._default_node
            + self._cache_url
            + "/"
    ...
    def _query_get(self, query_str: str, cache_name: str, local: bool = False) -> Any:
        api_url = (
            self._default_node
            + self._cache_url
            + "/"
    ...
    def post(self, key: str, data: str, cache_name: str) -> Any:
        """Post an entry
        Args:
    ...
    def put(self, key: str, data: str, cache_name: str) -> Any:
        """Put an entry
        Args:
            key(str): key of the entry
            data(str): content of the entry in json format
    ...
    def get(self, key: str, cache_name: str) -> Any:
        """Get an entry
        Args:
            key(str): key of the entry
            cache_name(str): target cache
    ...
    def schema_post(self, name: str, proto: str) -> Any:
        """Deploy a schema
        Args:
    ...
    def cache_post(self, name: str, config: str) -> Any:
        """Create a cache
        Args:
    ...
    def schema_delete(self, name: str) -> Any:
        """Delete a schema
        Args:
    ...
    def cache_delete(self, name: str) -> Any:
        """Delete a cache
        Args:
            name(str): name of the cache.
        Returns:
    ...
    def cache_clear(self, cache_name: str) -> Any:
        """Clear a cache
        Args:
    ...
    def index_clear(self, cache_name: str) -> Any:
    ...
    def index_reindex(self, cache_name: str) -> Any:
