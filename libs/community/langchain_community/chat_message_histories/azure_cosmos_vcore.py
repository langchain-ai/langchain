"""Azure Cosmos vCore Memory History."""
...
class AzureCosmosVCoreChatMessageHistory(BaseChatMessageHistory):
    """Chat message history that stores history in Azure Cosmos vCore.

    Args:
        connection_string: connection string to connect to Azure Cosmos vCore
    ...
    def messages(self) -> List[BaseMessage]:  # type: ignore
        """Retrieve the messages from Azure Cosmos vCore"""
    ...
    def add_message(self, message: BaseMessage) -> None:
        """Append the message to the record in Azure Cosmos vCore"""
        from pymongo import errors
    ...
    def clear(self) -> None:
        """Clear session memory from Azure Cosmos vCore"""
        from pymongo import errors
