...
if TYPE_CHECKING:
    ...
    from langchain_community.document_loaders.browserbase import BrowserbaseLoader
    ...
    from langchain_community.document_loaders.glue_catalog import (  # noqa: F401
        GlueCatalogLoader,
    )
    ...
    from langchain_community.document_loaders.oracleai import (  # noqa: F401
        OracleDocLoader,
        OracleTextSplitter,
    )
