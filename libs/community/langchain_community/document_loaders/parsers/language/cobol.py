...
class CobolSegmenter(CodeSegmenter):
    ...
    PARAGRAPH_PATTERN = re.compile(
        r"^(?!.*\b(REPOSITORY|SPECIAL-NAMES|SECURITY|DATE-COMPILED|SOURCE-COMPUTER|OBJECT-COMPUTER|FILE-CONTROL|FILE CONTROL|PROGRAM-ID|AUTHOR|DATE-WRITTEN|END-IF|END-PERFORM|GOBACK|EXIT|END IF|END PERFORM|END-PROGRAM|END PROGRAM|GO BACK|END-EXEC|END-EVALUATE)\b)[A-Z0-9\-]+(\s+.*)?\.$",  # noqa: E501
        re.IGNORECASE,
    )
