        ...
        for table in inspector.get_table_names():
            ...
            if foreign_keys:
                ...
                for fk in foreign_keys:
                    ...
                    const_columns = ", ".join(fk["constrained_columns"])
                    create_table += f"""
\n- {const_columns} references {fk["referred_table"]}({referred_columns})"""
                create_table += "\n*/\n"
    ...
    def get_foreign_key_info_str(self) -> str:
        ...
        for table in self.get_all_table_names():
            ...
            for fk in foreign_keys:
                ...
                foreign_one = f"""
{table}({constrained_cols}) references {fk["referred_table"]}({referred_cols})"""
