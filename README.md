...
🚨Поддержка агентов для GigaChat на данный момент находится в разработке.
...
## 🛠️ Примеры использования expression language

- [Использование Tool'ов для формирования поисковых запросов](docs/extras/expression_language/cookbook/tools.ipynb)
