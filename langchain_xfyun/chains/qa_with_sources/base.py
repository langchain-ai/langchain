...
from langchain_xfyun.chains.qa_with_sources.loading import load_qa_with_sources_chain
from langchain_xfyun.chains.qa_with_sources.map_reduce_prompt import (
    COMBINE_PROMPT,
    EXAMPLE_PROMPT,
    QUESTION_PROMPT,
)
