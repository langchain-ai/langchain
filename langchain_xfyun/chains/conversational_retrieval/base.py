...
from langchain_xfyun.chains.conversational_retrieval.prompts import CONDENSE_QUESTION_PROMPT
...
from langchain_xfyun.schema import BasePromptTemplate, BaseRetriever, Document
...
class ChatVectorDBChain(BaseConversationalRetrievalChain):
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from langchain_xfyun.chains import ConversationalRetrievalChain`"
        )
        return values
