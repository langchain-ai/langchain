...
from langchain_xfyun.prompts import BasePromptTemplate
from langchain_xfyun.pydantic_v1 import BaseModel
from langchain_xfyun.schema import BaseLLMOutputParser
    ...
    **kwargs: Any,
    ...
    Example:
        .. code-block:: python
                ...
                from langchain_xfyun.chains.openai_functions import create_openai_fn_chain
    ...
    **kwargs: Any,
    ...
    Example:
        .. code-block:: python
                ...
                from langchain_xfyun.chains.openai_functions import create_structured_output_chain
                from langchain_xfyun.chat_models import ChatOpenAI
                from langchain_xfyun.prompts import ChatPromptTemplate
