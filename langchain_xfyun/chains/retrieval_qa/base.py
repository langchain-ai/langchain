...
from langchain_xfyun.chains.combine_documents.base import BaseCombineDocumentsChain
...
from langchain_xfyun.chains.question_answering.stuff_prompt import PROMPT_SELECTOR
...
class RetrievalQA(BaseRetrievalQA):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.faiss import FAISS
            from langchain_xfyun.vectorstores.base import VectorStoreRetriever
...
class VectorDBQA(BaseRetrievalQA):
    ...
    def raise_deprecation(cls, values: Dict) -> Dict:
        warnings.warn(
            ...
            "please use `from langchain_xfyun.chains import RetrievalQA`"
        )
        return values
