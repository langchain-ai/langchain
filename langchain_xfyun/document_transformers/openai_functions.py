...
from langchain_xfyun.chains.openai_functions import create_tagging_chain
from langchain_xfyun.prompts import ChatPromptTemplate
from langchain_xfyun.pydantic_v1 import BaseModel
from langchain_xfyun.schema import BaseDocumentTransformer, Document
...
class OpenAIMetadataTagger(BaseDocumentTransformer, BaseModel):
    ...
    Example:
        .. code-block:: python
                ...
                from langchain_xfyun.document_transformers import OpenAIMetadataTagger
    ...
    *,
    ...
    Example:
        .. code-block:: python
                ...
                from langchain_xfyun.chat_models import ChatOpenAI
                from langchain_xfyun.document_transformers import create_metadata_tagger
                from langchain_xfyun.schema import Document
