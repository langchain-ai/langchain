...
from langchain_xfyun.callbacks.manager import CallbackManagerForToolRun
from langchain_xfyun.pydantic_v1 import BaseModel, Extra, Field
from langchain_xfyun.tools.office365.base import O365BaseTool
from langchain_xfyun.tools.office365.utils import clean_body
