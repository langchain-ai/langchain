...
from langchain_xfyun.pydantic_v1.dataclasses import dataclass
...
class GoogleApiClient:
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.document_loaders import GoogleApiClient
...
class GoogleApiYoutubeLoader(BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.document_loaders import GoogleApiClient
            from langchain_xfyun.document_loaders import GoogleApiYoutubeLoader
            google_api_client = GoogleApiClient(
                service_account_path=Path("path_to_your_sec_file.json")
            )
