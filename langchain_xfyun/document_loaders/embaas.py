...
from langchain_xfyun.pydantic_v1 import BaseModel, root_validator, validator
...
class EmbaasBlobLoader(BaseEmbaasLoader, BaseBlobParser):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from langchain_xfyun.document_loaders.embaas import EmbaasBlobLoader
...
class EmbaasLoader(BaseEmbaasLoader, BaseLoader):
    ...
    Example:
        .. code-block:: python
            ...
            # Default parsing
            from langchain_xfyun.document_loaders.embaas import EmbaasLoader
