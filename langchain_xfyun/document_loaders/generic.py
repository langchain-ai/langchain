...
from langchain_xfyun.document_loaders.base import BaseBlobParser, BaseLoader
from langchain_xfyun.document_loaders.blob_loaders import BlobLoader, FileSystemBlobLoader
from langchain_xfyun.document_loaders.parsers.registry import get_parser
from langchain_xfyun.schema import Document
from langchain_xfyun.text_splitter import TextSplitter
...
class GenericLoader(BaseLoader):
    ...
    Examples:
       ...
       .. code-block:: python
        ...
        from langchain_xfyun.document_loaders import GenericLoader
        ...
        .. code-block:: python
            ...
            from langchain_xfyun.document_loaders.parsers.pdf import PyPDFParser
