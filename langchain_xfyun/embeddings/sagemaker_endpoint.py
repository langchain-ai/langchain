...
from langchain_xfyun.llms.sagemaker_endpoint import ContentHandlerBase
...
class SagemakerEndpointEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.embeddings import SagemakerEndpointEmbeddings
            endpoint_name = (
                "my-endpoint-name"
            )
            region_name = (
    ...
    """
     Example:
        ...
        from langchain_xfyun.embeddings.sagemaker_endpoint import EmbeddingsContentHandler
