...
from langchain_xfyun.llms.ollama import _OllamaCommon
...
from langchain_xfyun.schema.output import ChatGeneration, ChatGenerationChunk
...
class ChatOllama(BaseChatModel, _OllamaCommon):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.chat_models import ChatOllama
