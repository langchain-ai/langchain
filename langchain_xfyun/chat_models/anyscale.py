...
from langchain_xfyun.adapters.openai import convert_message_to_dict
from langchain_xfyun.chat_models.openai import (
    ChatOpenAI,
    _import_tiktoken,
)
...
class ChatAnyscale(ChatOpenAI):
    ...
    Example:
        .. code-block:: python
            ...
            from langchain_xfyun.chat_models import ChatAnyscale
