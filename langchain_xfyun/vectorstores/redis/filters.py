...
from langchain_xfyun.utilities.redis import TokenEscaper
...
class RedisTag(RedisFilterField):
    ...
    def __eq__(self, other: Union[List[str], str]) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchain_xfyun.vectorstores.redis import RedisTag
...
class RedisNum(RedisFilterField):
    ...
    def __eq__(self, other: int) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchain_xfyun.vectorstores.redis import RedisNum
...
class RedisText(RedisFilterField):
    ...
    def __eq__(self, other: str) -> "RedisFilterExpression":
        ...
        Example:
            >>> from langchain_xfyun.vectorstores.redis import RedisText
...
class RedisFilterExpression:
    ...
    Examples:
        ...
        >>> from langchain_xfyun.vectorstores.redis import RedisTag, RedisNum
