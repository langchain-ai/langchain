...
from langchain_xfyun.evaluation.agents.trajectory_eval_prompt import (
    EVAL_CHAT_PROMPT,
    TOOL_FREE_EVAL_CHAT_PROMPT,
)
from langchain_xfyun.evaluation.schema import AgentTrajectoryEvaluator, LLMEvalChain
from langchain_xfyun.pydantic_v1 import Extra, Field
from langchain_xfyun.schema import AgentAction, BaseOutputParser, OutputParserException
...
class TrajectoryEvalChain(AgentTrajectoryEvaluator, LLMEvalChain):
    ...
    .. code-block:: python
        ...
        from langchain_xfyun.evaluation import TrajectoryEvalChain
        from langchain_xfyun.tools import tool
