...
CREATE POLICY IF NOT EXISTS "anon_select_crm_contacts"
    ON crm_contacts
    FOR SELECT
    TO anon
    USING (true);

CREATE POLICY IF NOT EXISTS "anon_select_crm_interactions"
    ON crm_interactions
    FOR SELECT
    TO anon
    USING (true);
...
CREATE POLICY IF NOT EXISTS "service_role_all_crm_contacts"
    ON crm_contacts
    FOR ALL
    TO service_role
    USING (true)
...
CREATE POLICY IF NOT EXISTS "service_role_all_crm_interactions"
    ON crm_interactions
    FOR ALL
    TO service_role
    USING (true)
