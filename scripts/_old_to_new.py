OLD_TO_NEW = {
    (
        ...
        "name": "FolderFacebookMessengerChatLoader",
        "asname": None,
    },
    (
        "langchain.chat_loaders.facebook_messenger",
        ...
        "new_module": "langchain_community.chat_loaders.facebook_messenger",
        "name": "SingleFileFacebookMessengerChatLoader",
        "asname": None,
    },
    ("langchain.chat_loaders.whatsapp", "WhatsAppChatLoader"): {
        "new_module": "langchain_community.chat_loaders.whatsapp",
        "name": "WhatsAppChatLoader",
        "asname": None,
    },
    ("langchain.chat_loaders.telegram", "TelegramChatLoader"): {
        "new_module": "langchain_community.chat_loaders.telegram",
    ...
    ("langchain.chat_loaders.langsmith", "LangSmithDatasetChatLoader"): {
        ...
        "name": "LangSmithDatasetChatLoader",
        "asname": None,
    },
    ...
    ("langchain.chat_loaders.imessage", "IMessageChatLoader"): {
        "new_module": "langchain_community.chat_loaders.imessage",
        "name": "IMessageChatLoader",
        "asname": None,
    },
    ("langchain.chat_loaders.gmail", "GMailLoader"): {
        "new_module": "langchain_community.chat_loaders.gmail",
        "name": "GMailLoader",
        "asname": None,
    },
    ("langchain.chat_loaders.utils", "map_ai_messages"): {
        "new_module": "langchain_community.chat_loaders.utils",
        "name": "map_ai_messages",
        "asname": None,
    },
    ("langchain.chat_loaders.utils", "map_ai_messages_in_session"): {
        "new_module": "langchain_community.chat_loaders.utils",
        "name": "map_ai_messages_in_session",
        "asname": None,
    },
    ("langchain.chat_loaders.utils", "merge_chat_runs"): {
        "new_module": "langchain_community.chat_loaders.utils",
        "name": "merge_chat_runs",
        "asname": None,
    },
    ("langchain.chat_loaders.utils", "merge_chat_runs_in_session"): {
        "new_module": "langchain_community.chat_loaders.utils",
        "name": "merge_chat_runs_in_session",
        "asname": None,
    },
    ("langchain.chat_loaders.base", "BaseChatLoader"): {
        "new_module": "langchain_community.chat_loaders.base",
        "name": "BaseChatLoader",
        "asname": None,
    },
    ("langchain.chat_loaders.slack", "SlackChatLoader"): {
        "new_module": "langchain_community.chat_loaders.slack",
        "name": "SlackChatLoader",
        "asname": None,
    },
    ("langchain.retrievers.bm25", "BM25Retriever"): {
        "new_module": "langchain_community.retrievers.bm25",
        "name": "BM25Retriever",
        "asname": None,
    },
    ("langchain.retrievers.bm25", "default_preprocessing_func"): {
        "new_module": "langchain_community.retrievers.bm25",
        "name": "default_preprocessing_func",
        "asname": None,
    },
    ("langchain.retrievers.docarray", "DocArrayRetriever"): {
        "new_module": "langchain_community.retrievers.docarray",
    ...
    ("langchain.retrievers.remote_retriever", "RemoteLangChainRetriever"): {
        "new_module": "langchain_community.retrievers.remote_retriever",
        "name": "RemoteLangChainRetriever",
        "asname": None,
    },
    ("langchain.retrievers.chatgpt_plugin_retriever", "ChatGPTPluginRetriever"): {
        "new_module": "langchain_community.retrievers.chatgpt_plugin_retriever",
        "name": "ChatGPTPluginRetriever",
        "asname": None,
    },
    ("langchain.retrievers.milvus", "MilvusRetreiver"): {
        "new_module": "langchain_community.retrievers.milvus",
        "name": "MilvusRetreiver",
        "asname": None,
    },
    ...
    ("langchain.retrievers.embedchain", "EmbedchainRetriever"): {
        "new_module": "langchain_community.retrievers.embedchain",
        "name": "EmbedchainRetriever",
        "asname": None,
    },
    ("langchain.retrievers.weaviate_hybrid_search", "WeaviateHybridSearchRetriever"): {
        "new_module": "langchain_community.retrievers.weaviate_hybrid_search",
    ...
    ("langchain.retrievers.pinecone_hybrid_search", "PineconeHybridSearchRetriever"): {
        "new_module": "langchain_community.retrievers.pinecone_hybrid_search",
        "name": "PineconeHybridSearchRetriever",
        "asname": None,
    },
    ("langchain.retrievers.arxiv", "ArxivRetriever"): {
        "new_module": "langchain_community.retrievers.arxiv",
        "name": "ArxivRetriever",
        "asname": None,
    },
    ("langchain.retrievers.chaindesk", "ChaindeskRetriever"): {
        "new_module": "langchain_community.retrievers.chaindesk",
    ...
    ("langchain.retrievers.llama_index", "LlamaIndexGraphRetriever"): {
        "new_module": "langchain_community.retrievers.llama_index",
    ...
    ("langchain.retrievers.azure_cognitive_search", "AzureCognitiveSearchRetriever"): {
        "new_module": "langchain_community.retrievers.azure_cognitive_search",
    ...
    (
        ...
        "new_module": "langchain_community.retrievers.google_vertex_ai_search",
    ...
    (
        ...
        "new_module": "langchain_community.retrievers.google_cloud_documentai_warehouse",
        "name": "GoogleDocumentAIWarehouseRetriever",
        "asname": None,
    },
    ("langchain.retrievers.databerry", "DataberryRetriever"): {
        "new_module": "langchain_community.retrievers.databerry",
    ...
    ("langchain.retrievers.kay", "KayAiRetriever"): {
        "new_module": "langchain_community.retrievers.kay",
        "name": "KayAiRetriever",
        "asname": None,
    },
    ("langchain.retrievers.zep", "SearchScope"): {
        "new_module": "langchain_community.retrievers.zep",
        "name": "SearchScope",
        "asname": None,
    },
    ...
    ("langchain.retrievers.you", "YouRetriever"): {
        "new_module": "langchain_community.retrievers.you",
        "name": "YouRetriever",
        "asname": None,
    },
    ("langchain.retrievers.elastic_search_bm25", "ElasticSearchBM25Retriever"): {
        "new_module": "langchain_community.retrievers.elastic_search_bm25",
        "name": "ElasticSearchBM25Retriever",
        "asname": None,
    },
    ...
    ("langchain.retrievers.kendra", "AdditionalResultAttribute"): {
        "new_module": "langchain_community.retrievers.kendra",
    ...
    ("langchain.retrievers.tavily_search_api", "SearchDepth"): {
        "new_module": "langchain_community.retrievers.tavily_search_api",
        "name": "SearchDepth",
        "asname": None,
    },
    ...
    ("langchain.retrievers.metal", "MetalRetriever"): {
        "new_module": "langchain_community.retrievers.metal",
        "name": "MetalRetriever",
        "asname": None,
    },
    ("langchain.retrievers.svm", "SVMRetriever"): {
        "new_module": "langchain_community.retrievers.svm",
        "name": "SVMRetriever",
        "asname": None,
    },
    ("langchain.retrievers.vespa_retriever", "VespaRetriever"): {
        "new_module": "langchain_community.retrievers.vespa_retriever",
        "name": "VespaRetriever",
        "asname": None,
    },
    ("langchain.retrievers.tfidf", "TFIDFRetriever"): {
        "new_module": "langchain_community.retrievers.tfidf",
        "name": "TFIDFRetriever",
        "asname": None,
    },
    ("langchain.retrievers.zilliz", "ZillizRetreiver"): {
        "new_module": "langchain_community.retrievers.zilliz",
        "name": "ZillizRetreiver",
        "asname": None,
    },
    ...
    ("langchain.retrievers.bedrock", "AmazonKnowledgeBasesRetriever"): {
        "new_module": "langchain_community.retrievers.bedrock",
        "name": "AmazonKnowledgeBasesRetriever",
        "asname": None,
    },
    ...
    ("langchain.retrievers.wikipedia", "WikipediaRetriever"): {
        "new_module": "langchain_community.retrievers.wikipedia",
        "name": "WikipediaRetriever",
        "asname": None,
    },
    ("langchain.retrievers.knn", "KNNRetriever"): {
        "new_module": "langchain_community.retrievers.knn",
        "name": "KNNRetriever",
        "asname": None,
    },
    ("langchain.tools.plugin", "AIPlugin"): {
        "new_module": "langchain_community.tools.plugin",
        "name": "AIPlugin",
        "asname": None,
    },
    ...
    ("langchain.tools.yahoo_finance_news", "YahooFinanceNewsTool"): {
        "new_module": "langchain_community.tools.yahoo_finance_news",
        "name": "YahooFinanceNewsTool",
        "asname": None,
    },
    ("langchain.tools.ifttt", "IFTTTWebhook"): {
        "new_module": "langchain_community.tools.ifttt",
        "name": "IFTTTWebhook",
        "asname": None,
    },
    ("langchain.embeddings.vertexai", "VertexAIEmbeddings"): {
        "new_module": "langchain_community.embeddings.vertexai",
        "name": "VertexAIEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.spacy_embeddings", "SpacyEmbeddings"): {
        "new_module": "langchain_community.embeddings.spacy_embeddings",
    ...
    ("langchain.embeddings.gpt4all", "GPT4AllEmbeddings"): {
        "new_module": "langchain_community.embeddings.gpt4all",
        "name": "GPT4AllEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.nlpcloud", "NLPCloudEmbeddings"): {
        "new_module": "langchain_community.embeddings.nlpcloud",
        "name": "NLPCloudEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.mlflow_gateway", "MlflowAIGatewayEmbeddings"): {
        "new_module": "langchain_community.embeddings.mlflow_gateway",
        "name": "MlflowAIGatewayEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.openai", "OpenAIEmbeddings"): {
        "new_module": "langchain_community.embeddings.openai",
        "name": "OpenAIEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.azure_openai", "AzureOpenAIEmbeddings"): {
        "new_module": "langchain_community.embeddings.azure_openai",
        "name": "AzureOpenAIEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.mosaicml", "MosaicMLInstructorEmbeddings"): {
        "new_module": "langchain_community.embeddings.mosaicml",
        "name": "MosaicMLInstructorEmbeddings",
        "asname": None,
    },
    ...
    ("langchain.embeddings.bookend", "BookendEmbeddings"): {
        "new_module": "langchain_community.embeddings.bookend",
        "name": "BookendEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.sagemaker_endpoint", "EmbeddingsContentHandler"): {
        "new_module": "langchain_community.embeddings.sagemaker_endpoint",
        "name": "EmbeddingsContentHandler",
        "asname": None,
    },
    ...
    ("langchain.embeddings.deepinfra", "DeepInfraEmbeddings"): {
        "new_module": "langchain_community.embeddings.deepinfra",
        "name": "DeepInfraEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.xinference", "XinferenceEmbeddings"): {
        "new_module": "langchain_community.embeddings.xinference",
        "name": "XinferenceEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.llm_rails", "LLMRailsEmbeddings"): {
        "new_module": "langchain_community.embeddings.llm_rails",
        "name": "LLMRailsEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.gradient_ai", "GradientEmbeddings"): {
        "new_module": "langchain_community.embeddings.gradient_ai",
        "name": "GradientEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.databricks", "DatabricksEmbeddings"): {
        "new_module": "langchain_community.embeddings.databricks",
        "name": "DatabricksEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.tensorflow_hub", "TensorflowHubEmbeddings"): {
        "new_module": "langchain_community.embeddings.tensorflow_hub",
        "name": "TensorflowHubEmbeddings",
        "asname": None,
    },
    (
        ...
        "new_module": "langchain_community.embeddings.self_hosted_hugging_face",
        "name": "SelfHostedHuggingFaceEmbeddings",
        "asname": None,
    },
    (
    ...
    ("langchain.embeddings.clarifai", "ClarifaiEmbeddings"): {
        "new_module": "langchain_community.embeddings.clarifai",
        "name": "ClarifaiEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.ernie", "ErnieEmbeddings"): {
        "new_module": "langchain_community.embeddings.ernie",
        "name": "ErnieEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.edenai", "EdenAiEmbeddings"): {
        "new_module": "langchain_community.embeddings.edenai",
        "name": "EdenAiEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.baidu_qianfan_endpoint", "QianfanEmbeddingsEndpoint"): {
        "new_module": "langchain_community.embeddings.baidu_qianfan_endpoint",
        "name": "QianfanEmbeddingsEndpoint",
        "asname": None,
    },
    ("langchain.embeddings.cohere", "CohereEmbeddings"): {
        "new_module": "langchain_community.embeddings.cohere",
        "name": "CohereEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.johnsnowlabs", "JohnSnowLabsEmbeddings"): {
        "new_module": "langchain_community.embeddings.johnsnowlabs",
        "name": "JohnSnowLabsEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.ollama", "OllamaEmbeddings"): {
        "new_module": "langchain_community.embeddings.ollama",
        "name": "OllamaEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.bedrock", "BedrockEmbeddings"): {
        "new_module": "langchain_community.embeddings.bedrock",
        "name": "BedrockEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.fastembed", "FastEmbedEmbeddings"): {
        "new_module": "langchain_community.embeddings.fastembed",
        "name": "FastEmbedEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.llamacpp", "LlamaCppEmbeddings"): {
        "new_module": "langchain_community.embeddings.llamacpp",
        "name": "LlamaCppEmbeddings",
        "asname": None,
    },
    ("langchain.embeddings.huggingface_hub", "HuggingFaceHubEmbeddings"): {
        "new_module": "langchain_community.embeddings.huggingface_hub",
        "name": "HuggingFaceHubEmbeddings",
        "asname": None,
    },
    ("langchain.memory.chat_memory", "ChatMessageHistory"): {
        "new_module": "langchain_community.chat_message_histories.in_memory",
    ...
    ("langchain.memory.entity", "get_client"): {
        "new_module": "langchain_community.utilities.redis",
        "name": "get_client",
        "asname": None,
    },
    ...
    ("langchain.memory.kg", "KnowledgeTriple"): {
        "new_module": "langchain_community.graphs.networkx_graph",
    ...
    ("langchain.callbacks.aim_callback", "BaseMetadataCallbackHandler"): {
        "new_module": "langchain_community.callbacks.aim_callback",
        "name": "BaseMetadataCallbackHandler",
        "asname": None,
    },
    ...
    ("langchain.callbacks.context_callback", "ContextCallbackHandler"): {
        "new_module": "langchain_community.callbacks.context_callback",
        "name": "ContextCallbackHandler",
        "asname": None,
    },
    ("langchain.callbacks.flyte_callback", "FlyteCallbackHandler"): {
        "new_module": "langchain_community.callbacks.flyte_callback",
        "name": "FlyteCallbackHandler",
        "asname": None,
    },
    ("langchain.callbacks.whylabs_callback", "WhyLabsCallbackHandler"): {
        "new_module": "langchain_community.callbacks.whylabs_callback",
        "name": "WhyLabsCallbackHandler",
        "asname": None,
    },
    ("langchain.callbacks.human", "AsyncHumanApprovalCallbackHandler"): {
        "new_module": "langchain_community.callbacks.human",
        "name": "AsyncHumanApprovalCallbackHandler",
        "asname": None,
    },
    ...
    ("langchain.callbacks.human", "HumanRejectedException"): {
        "new_module": "langchain_community.callbacks.human",
        "name": "HumanRejectedException",
        "asname": None,
    },
    ("langchain.callbacks.arize_callback", "ArizeCallbackHandler"): {
        "new_module": "langchain_community.callbacks.arize_callback",
        "name": "ArizeCallbackHandler",
        "asname": None,
    },
    ("langchain.callbacks.utils", "BaseMetadataCallbackHandler"): {
        "new_module": "langchain_community.callbacks.utils",
        "name": "BaseMetadataCallbackHandler",
        "asname": None,
    },
    ...
    ("langchain.callbacks.mlflow_callback", "MlflowCallbackHandler"): {
        "new_module": "langchain_community.callbacks.mlflow_callback",
        "name": "MlflowCallbackHandler",
        "asname": None,
    },
    ...
    (
        ...
        "new_module": "langchain_community.callbacks.mlflow_callback",
        "name": "construct_html_from_prompt_and_generation",
        "asname": None,
    },
    ("langchain.chat_models.vertexai", "ChatVertexAI"): {
        "new_module": "langchain_community.chat_models.vertexai",
        "name": "ChatVertexAI",
        "asname": None,
    },
    ("langchain.chat_models.hunyuan", "ChatHunyuan"): {
        "new_module": "langchain_community.chat_models.hunyuan",
        "name": "ChatHunyuan",
        "asname": None,
    },
    ("langchain.chat_models.tongyi", "ChatTongyi"): {
        "new_module": "langchain_community.chat_models.tongyi",
        "name": "ChatTongyi",
        "asname": None,
    },
    ("langchain.chat_models.azureml_endpoint", "AzureMLChatOnlineEndpoint"): {
        "new_module": "langchain_community.chat_models.azureml_endpoint",
        "name": "AzureMLChatOnlineEndpoint",
        "asname": None,
    },
    ("langchain.chat_models.azureml_endpoint", "LlamaContentFormatter"): {
        "new_module": "langchain_community.chat_models.azureml_endpoint",
        "name": "LlamaContentFormatter",
        "asname": None,
    },
    ("langchain.chat_models.google_palm", "ChatGooglePalm"): {
        "new_module": "langchain_community.chat_models.google_palm",
        "name": "ChatGooglePalm",
        "asname": None,
    },
    ("langchain.chat_models.google_palm", "ChatGooglePalmError"): {
        "new_module": "langchain_community.chat_models.google_palm",
        "name": "ChatGooglePalmError",
        "asname": None,
    },
    ("langchain.chat_models.fake", "FakeListChatModel"): {
        "new_module": "langchain_community.chat_models.fake",
    ...
    ("langchain.chat_models.minimax", "MiniMaxChat"): {
        "new_module": "langchain_community.chat_models.minimax",
        "name": "MiniMaxChat",
        "asname": None,
    },
    ("langchain.chat_models.mlflow", "ChatMlflow"): {
        "new_module": "langchain_community.chat_models.mlflow",
        "name": "ChatMlflow",
        "asname": None,
    },
    ("langchain.chat_models.promptlayer_openai", "PromptLayerChatOpenAI"): {
        "new_module": "langchain_community.chat_models.promptlayer_openai",
        "name": "PromptLayerChatOpenAI",
        "asname": None,
    },
    ("langchain.chat_models.mlflow_ai_gateway", "ChatMLflowAIGateway"): {
        "new_module": "langchain_community.chat_models.mlflow_ai_gateway",
    ...
    ("langchain.chat_models.anyscale", "ChatAnyscale"): {
        "new_module": "langchain_community.chat_models.anyscale",
        "name": "ChatAnyscale",
        "asname": None,
    },
    ("langchain.chat_models.yandex", "ChatYandexGPT"): {
        "new_module": "langchain_community.chat_models.yandex",
        "name": "ChatYandexGPT",
        "asname": None,
    },
    ...
    ("langchain.chat_models.human", "HumanInputChatModel"): {
        "new_module": "langchain_community.chat_models.human",
        "name": "HumanInputChatModel",
        "asname": None,
    },
    ("langchain.chat_models.litellm", "ChatLiteLLM"): {
        "new_module": "langchain_community.chat_models.litellm",
        "name": "ChatLiteLLM",
        "asname": None,
    },
    ("langchain.chat_models.litellm", "ChatLiteLLMException"): {
        "new_module": "langchain_community.chat_models.litellm",
        "name": "ChatLiteLLMException",
        "asname": None,
    },
    ("langchain.chat_models.openai", "ChatOpenAI"): {
        "new_module": "langchain_community.chat_models.openai",
        "name": "ChatOpenAI",
        "asname": None,
    },
    ("langchain.chat_models.konko", "ChatKonko"): {
        "new_module": "langchain_community.chat_models.konko",
        "name": "ChatKonko",
        "asname": None,
    },
    ("langchain.chat_models.azure_openai", "AzureChatOpenAI"): {
        "new_module": "langchain_community.chat_models.azure_openai",
        "name": "AzureChatOpenAI",
        "asname": None,
    },
    ("langchain.chat_models.volcengine_maas", "VolcEngineMaasChat"): {
        "new_module": "langchain_community.chat_models.volcengine_maas",
        "name": "VolcEngineMaasChat",
        "asname": None,
    },
    ("langchain.chat_models.volcengine_maas", "convert_dict_to_message"): {
        "new_module": "langchain_community.chat_models.volcengine_maas",
        "name": "convert_dict_to_message",
        "asname": None,
    },
    ("langchain.chat_models.pai_eas_endpoint", "PaiEasChatEndpoint"): {
        "new_module": "langchain_community.chat_models.pai_eas_endpoint",
        "name": "PaiEasChatEndpoint",
        "asname": None,
    },
    ("langchain.chat_models.fireworks", "ChatFireworks"): {
        "new_module": "langchain_community.chat_models.fireworks",
        "name": "ChatFireworks",
        "asname": None,
    },
    ("langchain.chat_models.anthropic", "ChatAnthropic"): {
        "new_module": "langchain_community.chat_models.anthropic",
        "name": "ChatAnthropic",
        "asname": None,
    },
    ("langchain.chat_models.anthropic", "convert_messages_to_prompt_anthropic"): {
        "new_module": "langchain_community.chat_models.anthropic",
        "name": "convert_messages_to_prompt_anthropic",
        "asname": None,
    },
    ("langchain.chat_models.baichuan", "ChatBaichuan"): {
        "new_module": "langchain_community.chat_models.baichuan",
        "name": "ChatBaichuan",
        "asname": None,
    },
    ("langchain.chat_models.databricks", "ChatDatabricks"): {
        "new_module": "langchain_community.chat_models.databricks",
        "name": "ChatDatabricks",
        "asname": None,
    },
    ("langchain.chat_models.ernie", "ErnieBotChat"): {
        "new_module": "langchain_community.chat_models.ernie",
        "name": "ErnieBotChat",
        "asname": None,
    },
    ("langchain.chat_models.baidu_qianfan_endpoint", "QianfanChatEndpoint"): {
        "new_module": "langchain_community.chat_models.baidu_qianfan_endpoint",
        "name": "QianfanChatEndpoint",
        "asname": None,
    },
    ("langchain.chat_models.cohere", "ChatCohere"): {
        "new_module": "langchain_community.chat_models.cohere",
        "name": "ChatCohere",
        "asname": None,
    },
    ("langchain.chat_models.ollama", "ChatOllama"): {
        "new_module": "langchain_community.chat_models.ollama",
        "name": "ChatOllama",
        "asname": None,
    },
    ...
    ("langchain.chat_models.gigachat", "GigaChat"): {
        "new_module": "langchain_community.chat_models.gigachat",
        "name": "GigaChat",
        "asname": None,
    },
    ("langchain.chat_models.bedrock", "BedrockChat"): {
        "new_module": "langchain_community.chat_models.bedrock",
        "name": "BedrockChat",
        "asname": None,
    },
    ("langchain.chat_models.bedrock", "ChatPromptAdapter"): {
        "new_module": "langchain_community.chat_models.bedrock",
        "name": "ChatPromptAdapter",
        "asname": None,
    },
    ("langchain.chat_models.everlyai", "ChatEverlyAI"): {
        "new_module": "langchain_community.chat_models.everlyai",
        "name": "ChatEverlyAI",
        "asname": None,
    },
    ("langchain.chat_models.meta", "convert_messages_to_prompt_llama"): {
        "new_module": "langchain_community.chat_models.meta",
    ...
    ("langchain.agents.load_tools", "DallEAPIWrapper"): {
        "new_module": "langchain_community.utilities.dalle_image_generator",
        "name": "DallEAPIWrapper",
        "asname": None,
    },
    ...
    ("langchain.agents.load_tools", "ArxivQueryRun"): {
        "new_module": "langchain_community.tools.arxiv.tool",
        "name": "ArxivQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "GoldenQueryRun"): {
        "new_module": "langchain_community.tools.golden_query.tool",
        "name": "GoldenQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "PubmedQueryRun"): {
        "new_module": "langchain_community.tools.pubmed.tool",
        "name": "PubmedQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "BingSearchRun"): {
        "new_module": "langchain_community.tools.bing_search.tool",
        "name": "BingSearchRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "DuckDuckGoSearchRun"): {
        "new_module": "langchain_community.tools.ddg_search.tool",
        "name": "DuckDuckGoSearchRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "GoogleCloudTextToSpeechTool"): {
        "new_module": "langchain_community.tools.google_cloud.texttospeech",
        "name": "GoogleCloudTextToSpeechTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "GoogleLensQueryRun"): {
        "new_module": "langchain_community.tools.google_lens.tool",
        "name": "GoogleLensQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "GoogleSearchResults"): {
        "new_module": "langchain_community.tools.google_search.tool",
    ...
    ("langchain.agents.load_tools", "SearchAPIResults"): {
        "new_module": "langchain_community.tools.searchapi.tool",
    ...
    ("langchain.agents.load_tools", "BaseGraphQLTool"): {
        "new_module": "langchain_community.tools.graphql.tool",
        "name": "BaseGraphQLTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "HumanInputRun"): {
        "new_module": "langchain_community.tools.human.tool",
        "name": "HumanInputRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "RequestsDeleteTool"): {
        "new_module": "langchain_community.tools.requests.tool",
        "name": "RequestsDeleteTool",
        "asname": None,
    },
    ...
    ("langchain.agents.load_tools", "RequestsPutTool"): {
        "new_module": "langchain_community.tools.requests.tool",
        "name": "RequestsPutTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "ElevenLabsText2SpeechTool"): {
        "new_module": "langchain_community.tools.eleven_labs.text2speech",
        "name": "ElevenLabsText2SpeechTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "SceneXplainTool"): {
        "new_module": "langchain_community.tools.scenexplain.tool",
        "name": "SceneXplainTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "SearxSearchResults"): {
        "new_module": "langchain_community.tools.searx_search.tool",
        "name": "SearxSearchResults",
        "asname": None,
    },
    ...
    ("langchain.agents.load_tools", "ShellTool"): {
        "new_module": "langchain_community.tools.shell.tool",
        "name": "ShellTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "SleepTool"): {
        "new_module": "langchain_community.tools.sleep.tool",
        "name": "SleepTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "StackExchangeTool"): {
        "new_module": "langchain_community.tools.stackexchange.tool",
        "name": "StackExchangeTool",
        "asname": None,
    },
    ("langchain.agents.load_tools", "MerriamWebsterQueryRun"): {
        "new_module": "langchain_community.tools.merriam_webster.tool",
        "name": "MerriamWebsterQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "WikipediaQueryRun"): {
        "new_module": "langchain_community.tools.wikipedia.tool",
        "name": "WikipediaQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "WolframAlphaQueryRun"): {
        "new_module": "langchain_community.tools.wolfram_alpha.tool",
        "name": "WolframAlphaQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "OpenWeatherMapQueryRun"): {
        "new_module": "langchain_community.tools.openweathermap.tool",
        "name": "OpenWeatherMapQueryRun",
        "asname": None,
    },
    ("langchain.agents.load_tools", "DataForSeoAPISearchRun"): {
        "new_module": "langchain_community.tools.dataforseo_api_search",
    ...
    ("langchain.utils.ernie_functions", "convert_pydantic_to_ernie_function"): {
        "new_module": "langchain_community.utils.ernie_functions",
        "name": "convert_pydantic_to_ernie_function",
        "asname": None,
    },
    ("langchain.utils.ernie_functions", "convert_pydantic_to_ernie_tool"): {
        "new_module": "langchain_community.utils.ernie_functions",
        "name": "convert_pydantic_to_ernie_tool",
        "asname": None,
    },
    ("langchain.utils.openai_functions", "FunctionDescription"): {
        "new_module": "langchain_community.utils.openai_functions",
        "name": "FunctionDescription",
        "asname": None,
    },
    ...
    ("langchain.utils.openai_functions", "convert_pydantic_to_openai_function"): {
        "new_module": "langchain_community.utils.openai_functions",
        "name": "convert_pydantic_to_openai_function",
        "asname": None,
    },
    ...
    ("langchain.storage.redis", "RedisStore"): {
        "new_module": "langchain_community.storage.redis",
        "name": "RedisStore",
        "asname": None,
    },
    ...
    ("langchain.utilities.vertexai", "create_retry_decorator"): {
        "new_module": "langchain_community.utilities.vertexai",
    ...
    ("langchain.utilities.vertexai", "raise_vertex_import_error"): {
        "new_module": "langchain_community.utilities.vertexai",
        "name": "raise_vertex_import_error",
        "asname": None,
    },
    ...
    ("langchain.utilities.nasa", "NasaAPIWrapper"): {
        "new_module": "langchain_community.utilities.nasa",
        "name": "NasaAPIWrapper",
        "asname": None,
    },
    ("langchain.utilities.portkey", "Portkey"): {
        "new_module": "langchain_community.utilities.portkey",
        "name": "Portkey",
        "asname": None,
    },
    ...
    ("langchain.utilities.max_compute", "MaxComputeAPIWrapper"): {
        "new_module": "langchain_community.utilities.max_compute",
    ...
    ("langchain.utilities.google_places_api", "GooglePlacesAPIWrapper"): {
        "new_module": "langchain_community.utilities.google_places_api",
    ...
    ("langchain.utilities.zapier", "ZapierNLAWrapper"): {
        "new_module": "langchain_community.utilities.zapier",
        "name": "ZapierNLAWrapper",
        "asname": None,
    },
    ("langchain.utilities.apify", "ApifyWrapper"): {
        "new_module": "langchain_community.utilities.apify",
        "name": "ApifyWrapper",
        "asname": None,
    },
    ("langchain.utilities.gitlab", "GitLabAPIWrapper"): {
        "new_module": "langchain_community.utilities.gitlab",
        "name": "GitLabAPIWrapper",
        "asname": None,
    },
    ...
    ("langchain.utilities.openapi", "HTTPVerb"): {
        "new_module": "langchain_community.utilities.openapi",
        "name": "HTTPVerb",
        "asname": None,
    },
    ...
    ("langchain.utilities.brave_search", "BraveSearchWrapper"): {
        "new_module": "langchain_community.utilities.brave_search",
    ...
    ("langchain.utilities.arcee", "ArceeDocument"): {
        "new_module": "langchain_community.utilities.arcee",
        "name": "ArceeDocument",
        "asname": None,
    },
    ("langchain.utilities.arcee", "ArceeDocumentAdapter"): {
        "new_module": "langchain_community.utilities.arcee",
        "name": "ArceeDocumentAdapter",
        "asname": None,
    },
    ("langchain.utilities.arcee", "ArceeDocumentSource"): {
        "new_module": "langchain_community.utilities.arcee",
        "name": "ArceeDocumentSource",
        "asname": None,
    },
    ...
    ("langchain.utilities.scenexplain", "SceneXplainAPIWrapper"): {
        "new_module": "langchain_community.utilities.scenexplain",
        "name": "SceneXplainAPIWrapper",
        "asname": None,
    },
    ...
    ("langchain.utilities.sql_database", "SQLDatabase"): {
        "new_module": "langchain_community.utilities.sql_database",
        "name": "SQLDatabase",
        "asname": None,
    },
    ...
    ("langchain.utilities.powerbi", "PowerBIDataset"): {
        "new_module": "langchain_community.utilities.powerbi",
        "name": "PowerBIDataset",
        "asname": None,
    },
    ...
    ("langchain.utilities.outline", "OutlineAPIWrapper"): {
        "new_module": "langchain_community.utilities.outline",
        "name": "OutlineAPIWrapper",
        "asname": None,
    },
    ...
    ("langchain.utilities.tensorflow_datasets", "TensorflowDatasets"): {
        "new_module": "langchain_community.utilities.tensorflow_datasets",
        "name": "TensorflowDatasets",
        "asname": None,
    },
    ...
    ("langchain.utilities.python", "PythonREPL"): {
        "new_module": "langchain_community.utilities.python",
        "name": "PythonREPL",
        "asname": None,
    },
    ("langchain.utilities.anthropic", "get_num_tokens_anthropic"): {
        "new_module": "langchain_community.utilities.anthropic",
        "name": "get_num_tokens_anthropic",
        "asname": None,
    },
    ("langchain.utilities.anthropic", "get_token_ids_anthropic"): {
        "new_module": "langchain_community.utilities.anthropic",
        "name": "get_token_ids_anthropic",
        "asname": None,
    },
    ("langchain.utilities.jira", "JiraAPIWrapper"): {
        "new_module": "langchain_community.utilities.jira",
        "name": "JiraAPIWrapper",
        "asname": None,
    },
    ("langchain.utilities.clickup", "ClickupAPIWrapper"): {
        "new_module": "langchain_community.utilities.clickup",
        "name": "ClickupAPIWrapper",
        "asname": None,
    },
    ...
    ("langchain.utilities.github", "GitHubAPIWrapper"): {
        "new_module": "langchain_community.utilities.github",
        "name": "GitHubAPIWrapper",
        "asname": None,
    },
    ...
    ("langchain.utilities.bibtex", "BibtexparserWrapper"): {
        "new_module": "langchain_community.utilities.bibtex",
        "name": "BibtexparserWrapper",
        "asname": None,
    },
    ...
    ("langchain.utilities.spark_sql", "SparkSQL"): {
        "new_module": "langchain_community.utilities.spark_sql",
        "name": "SparkSQL",
        "asname": None,
    },
    ...
    ("langchain.utilities.steam", "SteamWebAPIWrapper"): {
        "new_module": "langchain_community.utilities.steam",
        "name": "SteamWebAPIWrapper",
        "asname": None,
    },
    ("langchain.utilities.opaqueprompts", "desanitize"): {
        "new_module": "langchain_community.utilities.opaqueprompts",
        "name": "desanitize",
        "asname": None,
    },
    ...
    ("langchain.utilities.alpha_vantage", "AlphaVantageAPIWrapper"): {
        "new_module": "langchain_community.utilities.alpha_vantage",
        "name": "AlphaVantageAPIWrapper",
        "asname": None,
    },
    ...
    ("langchain.vectorstores.cassandra", "CVST"): {
        "new_module": "langchain_community.vectorstores.cassandra",
        "name": "CVST",
        "asname": None,
    },
    ...
    ("langchain.vectorstores.elasticsearch", "ExactRetrievalStrategy"): {
        "new_module": "langchain_community.vectorstores.elasticsearch",
        "name": "ExactRetrievalStrategy",
        "asname": None,
    },
    ("langchain.vectorstores.elasticsearch", "SparseRetrievalStrategy"): {
        "new_module": "langchain_community.vectorstores.elasticsearch",
        "name": "SparseRetrievalStrategy",
        "asname": None,
    },
    ("langchain.vectorstores.milvus", "Milvus"): {
        "new_module": "langchain_community.vectorstores.milvus",
        "name": "Milvus",
        "asname": None,
    },
    ("langchain.vectorstores.usearch", "USearch"): {
        "new_module": "langchain_community.vectorstores.usearch",
        "name": "USearch",
        "asname": None,
    },
    ("langchain.vectorstores.clickhouse", "Clickhouse"): {
        "new_module": "langchain_community.vectorstores.clickhouse",
        "name": "Clickhouse",
        "asname": None,
    },
    ...
    ("langchain.vectorstores.tiledb", "TileDB"): {
        "new_module": "langchain_community.vectorstores.tiledb",
        "name": "TileDB",
        "asname": None,
    },
    ("langchain.vectorstores.myscale", "MyScale"): {
        "new_module": "langchain_community.vectorstores.myscale",
        "name": "MyScale",
        "asname": None,
    },
    ...
    ("langchain.vectorstores.myscale", "MyScaleWithoutJSON"): {
        "new_module": "langchain_community.vectorstores.myscale",
        "name": "MyScaleWithoutJSON",
        "asname": None,
    },
    ("langchain.vectorstores.tencentvectordb", "ConnectionParams"): {
        "new_module": "langchain_community.vectorstores.tencentvectordb",
    ...
    ("langchain.vectorstores.pinecone", "Pinecone"): {
        "new_module": "langchain_community.vectorstores.pinecone",
        "name": "Pinecone",
        "asname": None,
    },
    ("langchain.vectorstores.awadb", "AwaDB"): {
        "new_module": "langchain_community.vectorstores.awadb",
        "name": "AwaDB",
        "asname": None,
    },
    ("langchain.vectorstores.opensearch_vector_search", "OpenSearchVectorSearch"): {
        "new_module": "langchain_community.vectorstores.opensearch_vector_search",
        "name": "OpenSearchVectorSearch",
        "asname": None,
    },
    ("langchain.vectorstores.supabase", "SupabaseVectorStore"): {
        "new_module": "langchain_community.vectorstores.supabase",
        "name": "SupabaseVectorStore",
        "asname": None,
    },
    ("langchain.vectorstores.rocksetdb", "Rockset"): {
        "new_module": "langchain_community.vectorstores.rocksetdb",
        "name": "Rockset",
        "asname": None,
    },
    ("langchain.vectorstores.baiducloud_vector_search", "BESVectorStore"): {
        "new_module": "langchain_community.vectorstores.baiducloud_vector_search",
        "name": "BESVectorStore",
        "asname": None,
    },
    ("langchain.vectorstores.tigris", "Tigris"): {
        "new_module": "langchain_community.vectorstores.tigris",
        "name": "Tigris",
        "asname": None,
    },
    ("langchain.vectorstores.qdrant", "Qdrant"): {
        "new_module": "langchain_community.vectorstores.qdrant",
        "name": "Qdrant",
        "asname": None,
    },
    ("langchain.vectorstores.qdrant", "QdrantException"): {
        "new_module": "langchain_community.vectorstores.qdrant",
        "name": "QdrantException",
        "asname": None,
    },
    ("langchain.vectorstores.astradb", "AstraDB"): {
        "new_module": "langchain_community.vectorstores.astradb",
        "name": "AstraDB",
        "asname": None,
    },
    ("langchain.vectorstores.vearch", "Vearch"): {
        "new_module": "langchain_community.vectorstores.vearch",
        "name": "Vearch",
        "asname": None,
    },
    ("langchain.vectorstores.hologres", "Hologres"): {
        "new_module": "langchain_community.vectorstores.hologres",
        "name": "Hologres",
        "asname": None,
    },
    ("langchain.vectorstores.analyticdb", "AnalyticDB"): {
        "new_module": "langchain_community.vectorstores.analyticdb",
        "name": "AnalyticDB",
        "asname": None,
    },
    ("langchain.vectorstores.meilisearch", "Meilisearch"): {
        "new_module": "langchain_community.vectorstores.meilisearch",
        "name": "Meilisearch",
        "asname": None,
    },
    ("langchain.vectorstores.mongodb_atlas", "MongoDBAtlasVectorSearch"): {
        "new_module": "langchain_community.vectorstores.mongodb_atlas",
        "name": "MongoDBAtlasVectorSearch",
        "asname": None,
    },
    ("langchain.vectorstores.mongodb_atlas", "MongoDBDocumentType"): {
        "new_module": "langchain_community.vectorstores.mongodb_atlas",
        "name": "MongoDBDocumentType",
        "asname": None,
    },
    ("langchain.vectorstores.matching_engine", "MatchingEngine"): {
        "new_module": "langchain_community.vectorstores.matching_engine",
        "name": "MatchingEngine",
        "asname": None,
    },
    ...
    ("langchain.vectorstores.marqo", "Marqo"): {
        "new_module": "langchain_community.vectorstores.marqo",
        "name": "Marqo",
        "asname": None,
    },
    ("langchain.vectorstores.pgvecto_rs", "PGVecto_rs"): {
        "new_module": "langchain_community.vectorstores.pgvecto_rs",
        "name": "PGVecto_rs",
        "asname": None,
    },
    ("langchain.vectorstores.semadb", "SemaDB"): {
        "new_module": "langchain_community.vectorstores.semadb",
        "name": "SemaDB",
        "asname": None,
    },
    ("langchain.vectorstores.zep", "CollectionConfig"): {
        "new_module": "langchain_community.vectorstores.zep",
    ...
    ("langchain.vectorstores.epsilla", "Epsilla"): {
        "new_module": "langchain_community.vectorstores.epsilla",
        "name": "Epsilla",
        "asname": None,
    },
    ("langchain.vectorstores.faiss", "FAISS"): {
        "new_module": "langchain_community.vectorstores.faiss",
        "name": "FAISS",
        "asname": None,
    },
    ("langchain.vectorstores.timescalevector", "TimescaleVector"): {
        "new_module": "langchain_community.vectorstores.timescalevector",
        "name": "TimescaleVector",
        "asname": None,
    },
    ("langchain.vectorstores.nucliadb", "NucliaDB"): {
        "new_module": "langchain_community.vectorstores.nucliadb",
        "name": "NucliaDB",
        "asname": None,
    },
    ("langchain.vectorstores.xata", "XataVectorStore"): {
        "new_module": "langchain_community.vectorstores.xata",
        "name": "XataVectorStore",
        "asname": None,
    },
    ("langchain.vectorstores.scann", "ScaNN"): {
        "new_module": "langchain_community.vectorstores.scann",
        "name": "ScaNN",
        "asname": None,
    },
    ("langchain.vectorstores.databricks_vector_search", "DatabricksVectorSearch"): {
        "new_module": "langchain_community.vectorstores.databricks_vector_search",
        "name": "DatabricksVectorSearch",
        "asname": None,
    },
    ("langchain.vectorstores.dashvector", "DashVector"): {
        "new_module": "langchain_community.vectorstores.dashvector",
        "name": "DashVector",
        "asname": None,
    },
    ("langchain.vectorstores.vespa", "VespaStore"): {
        "new_module": "langchain_community.vectorstores.vespa",
        "name": "VespaStore",
        "asname": None,
    },
    ("langchain.vectorstores.pgvector", "DistanceStrategy"): {
        "new_module": "langchain_community.vectorstores.pgvector",
    ...
    ("langchain.vectorstores.vectara", "Vectara"): {
        "new_module": "langchain_community.vectorstores.vectara",
        "name": "Vectara",
        "asname": None,
    },
    ("langchain.vectorstores.vectara", "VectaraRetriever"): {
        "new_module": "langchain_community.vectorstores.vectara",
        "name": "VectaraRetriever",
        "asname": None,
    },
    ("langchain.vectorstores.utils", "DistanceStrategy"): {
        "new_module": "langchain_community.vectorstores.utils",
        "name": "DistanceStrategy",
        "asname": None,
    },
    ("langchain.vectorstores.utils", "filter_complex_metadata"): {
        "new_module": "langchain_community.vectorstores.utils",
        "name": "filter_complex_metadata",
        "asname": None,
    },
    ("langchain.vectorstores.utils", "maximal_marginal_relevance"): {
        "new_module": "langchain_community.vectorstores.utils",
        "name": "maximal_marginal_relevance",
        "asname": None,
    },
    ("langchain.vectorstores.hippo", "Hippo"): {
        "new_module": "langchain_community.vectorstores.hippo",
        "name": "Hippo",
        "asname": None,
    },
    ("langchain.vectorstores.weaviate", "Weaviate"): {
        "new_module": "langchain_community.vectorstores.weaviate",
        "name": "Weaviate",
        "asname": None,
    },
    ("langchain.vectorstores.vald", "Vald"): {
        "new_module": "langchain_community.vectorstores.vald",
        "name": "Vald",
        "asname": None,
    },
    ("langchain.vectorstores.sqlitevss", "SQLiteVSS"): {
        "new_module": "langchain_community.vectorstores.sqlitevss",
        "name": "SQLiteVSS",
        "asname": None,
    },
    ("langchain.vectorstores.lancedb", "LanceDB"): {
        "new_module": "langchain_community.vectorstores.lancedb",
        "name": "LanceDB",
        "asname": None,
    },
    ("langchain.vectorstores.deeplake", "DeepLake"): {
        "new_module": "langchain_community.vectorstores.deeplake",
        "name": "DeepLake",
        "asname": None,
    },
    ("langchain.vectorstores.llm_rails", "LLMRails"): {
        "new_module": "langchain_community.vectorstores.llm_rails",
        "name": "LLMRails",
        "asname": None,
    },
    ("langchain.vectorstores.llm_rails", "LLMRailsRetriever"): {
        "new_module": "langchain_community.vectorstores.llm_rails",
        "name": "LLMRailsRetriever",
        "asname": None,
    },
    ("langchain.vectorstores.yellowbrick", "Yellowbrick"): {
        "new_module": "langchain_community.vectorstores.yellowbrick",
        "name": "Yellowbrick",
        "asname": None,
    },
    ("langchain.vectorstores.atlas", "AtlasDB"): {
        "new_module": "langchain_community.vectorstores.atlas",
        "name": "AtlasDB",
        "asname": None,
    },
    ("langchain.vectorstores.clarifai", "Clarifai"): {
        "new_module": "langchain_community.vectorstores.clarifai",
        "name": "Clarifai",
        "asname": None,
    },
    ("langchain.vectorstores.sklearn", "BaseSerializer"): {
        "new_module": "langchain_community.vectorstores.sklearn",
        "name": "BaseSerializer",
        "asname": None,
    },
    ...
    ("langchain.vectorstores.sklearn", "SKLearnVectorStoreException"): {
        "new_module": "langchain_community.vectorstores.sklearn",
        "name": "SKLearnVectorStoreException",
        "asname": None,
    },
    ("langchain.vectorstores.chroma", "Chroma"): {
        "new_module": "langchain_community.vectorstores.chroma",
        "name": "Chroma",
        "asname": None,
    },
    ("langchain.vectorstores.tair", "Tair"): {
        "new_module": "langchain_community.vectorstores.tair",
        "name": "Tair",
        "asname": None,
    },
    ("langchain.vectorstores.neo4j_vector", "Neo4jVector"): {
        "new_module": "langchain_community.vectorstores.neo4j_vector",
        "name": "Neo4jVector",
        "asname": None,
    },
    ...
    ("langchain.vectorstores.starrocks", "StarRocks"): {
        "new_module": "langchain_community.vectorstores.starrocks",
        "name": "StarRocks",
        "asname": None,
    },
    ("langchain.vectorstores.starrocks", "StarRocksSettings"): {
        "new_module": "langchain_community.vectorstores.starrocks",
        "name": "StarRocksSettings",
        "asname": None,
    },
    ("langchain.vectorstores.alibabacloud_opensearch", "AlibabaCloudOpenSearch"): {
        "new_module": "langchain_community.vectorstores.alibabacloud_opensearch",
        "name": "AlibabaCloudOpenSearch",
        "asname": None,
    },
    (
    ...
    ("langchain.vectorstores.annoy", "Annoy"): {
        "new_module": "langchain_community.vectorstores.annoy",
        "name": "Annoy",
        "asname": None,
    },
    ("langchain.adapters.openai", "Chat"): {
        "new_module": "langchain_community.adapters.openai",
        "name": "Chat",
        "asname": None,
    },
    ...
    ("langchain.adapters.openai", "convert_message_to_dict"): {
        "new_module": "langchain_community.adapters.openai",
        "name": "convert_message_to_dict",
        "asname": None,
    },
    ("langchain.adapters.openai", "convert_messages_for_finetuning"): {
        "new_module": "langchain_community.adapters.openai",
        "name": "convert_messages_for_finetuning",
        "asname": None,
    },
    ("langchain.adapters.openai", "convert_openai_messages"): {
        "new_module": "langchain_community.adapters.openai",
        "name": "convert_openai_messages",
        "asname": None,
    },
    ("langchain.output_parsers.ernie_functions", "JsonKeyOutputFunctionsParser"): {
        "new_module": "langchain_community.output_parsers.ernie_functions",
        "name": "JsonKeyOutputFunctionsParser",
        "asname": None,
    },
    ...
    ("langchain.output_parsers.ernie_functions", "PydanticOutputFunctionsParser"): {
        "new_module": "langchain_community.output_parsers.ernie_functions",
        "name": "PydanticOutputFunctionsParser",
        "asname": None,
    },
    ...
    (
        ...
        "new_module": "langchain_community.document_transformers.embeddings_redundant_filter",
    ...
    (
        ...
        "new_module": "langchain_community.document_transformers.embeddings_redundant_filter",
        "name": "_filter_similar_embeddings",
        "asname": None,
    },
    (
        "langchain.document_transformers.embeddings_redundant_filter",
        ...
        "new_module": "langchain_community.document_transformers.embeddings_redundant_filter",
        "name": "_get_embeddings_from_stateful_docs",
        "asname": None,
    },
    (
        "langchain.document_transformers.embeddings_redundant_filter",
    ...
    (
        ...
        "new_module": "langchain_community.document_transformers.google_translate",
        "name": "GoogleTranslateTransformer",
        "asname": None,
    },
    ("langchain.document_transformers.html2text", "Html2TextTransformer"): {
        "new_module": "langchain_community.document_transformers.html2text",
        "name": "Html2TextTransformer",
        "asname": None,
    },
    ...
    (
        ...
        "new_module": "langchain_community.document_transformers.beautiful_soup_transformer",
        "name": "BeautifulSoupTransformer",
        "asname": None,
    },
    (
        ...
        "new_module": "langchain_community.document_transformers.doctran_text_translate",
        "name": "DoctranTextTranslator",
        "asname": None,
    },
    ("langchain.document_transformers.long_context_reorder", "LongContextReorder"): {
        "new_module": "langchain_community.document_transformers.long_context_reorder",
        "name": "LongContextReorder",
        "asname": None,
    },
    (
        ...
        "new_module": "langchain_community.document_transformers.nuclia_text_transform",
        "name": "NucliaTextTransformer",
        "asname": None,
    },
    ...
    ("langchain.docstore.base", "AddableMixin"): {
        "new_module": "langchain_community.docstore.base",
        "name": "AddableMixin",
        "asname": None,
    },
    ...
    ("langchain.docstore.in_memory", "InMemoryDocstore"): {
        "new_module": "langchain_community.docstore.in_memory",
        "name": "InMemoryDocstore",
        "asname": None,
    },
    ("langchain.docstore.wikipedia", "Wikipedia"): {
        "new_module": "langchain_community.docstore.wikipedia",
        "name": "Wikipedia",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.rss", "RSSFeedLoader"): {
        "new_module": "langchain_community.document_loaders.rss",
        "name": "RSSFeedLoader",
        "asname": None,
    },
    ("langchain.document_loaders.max_compute", "MaxComputeLoader"): {
        "new_module": "langchain_community.document_loaders.max_compute",
        "name": "MaxComputeLoader",
        "asname": None,
    },
    ("langchain.document_loaders.git", "GitLoader"): {
        "new_module": "langchain_community.document_loaders.git",
        "name": "GitLoader",
        "asname": None,
    },
    ("langchain.document_loaders.obs_directory", "OBSDirectoryLoader"): {
        "new_module": "langchain_community.document_loaders.obs_directory",
        "name": "OBSDirectoryLoader",
        "asname": None,
    },
    ("langchain.document_loaders.concurrent", "ConcurrentLoader"): {
        "new_module": "langchain_community.document_loaders.concurrent",
        "name": "ConcurrentLoader",
        "asname": None,
    },
    ("langchain.document_loaders.roam", "RoamLoader"): {
        "new_module": "langchain_community.document_loaders.roam",
        "name": "RoamLoader",
        "asname": None,
    },
    ("langchain.document_loaders.merge", "MergedDataLoader"): {
        "new_module": "langchain_community.document_loaders.merge",
        "name": "MergedDataLoader",
        "asname": None,
    },
    ("langchain.document_loaders.youtube", "GoogleApiClient"): {
        "new_module": "langchain_community.document_loaders.youtube",
    ...
    ("langchain.document_loaders.pubmed", "PubMedLoader"): {
        "new_module": "langchain_community.document_loaders.pubmed",
        "name": "PubMedLoader",
        "asname": None,
    },
    ("langchain.document_loaders.confluence", "ConfluenceLoader"): {
        "new_module": "langchain_community.document_loaders.confluence",
    ...
    ("langchain.document_loaders.mastodon", "MastodonTootsLoader"): {
        "new_module": "langchain_community.document_loaders.mastodon",
        "name": "MastodonTootsLoader",
        "asname": None,
    },
    ("langchain.document_loaders.telegram", "TelegramChatApiLoader"): {
        "new_module": "langchain_community.document_loaders.telegram",
    ...
    ("langchain.document_loaders.arcgis_loader", "ArcGISLoader"): {
        "new_module": "langchain_community.document_loaders.arcgis_loader",
        "name": "ArcGISLoader",
        "asname": None,
    },
    ("langchain.document_loaders.brave_search", "BraveSearchLoader"): {
        "new_module": "langchain_community.document_loaders.brave_search",
        "name": "BraveSearchLoader",
        "asname": None,
    },
    ("langchain.document_loaders.datadog_logs", "DatadogLogsLoader"): {
        "new_module": "langchain_community.document_loaders.datadog_logs",
    ...
    (
        ...
        "new_module": "langchain_community.document_loaders.azure_blob_storage_container",
        "name": "AzureBlobStorageContainerLoader",
        "asname": None,
    },
    ("langchain.document_loaders.lakefs", "LakeFSClient"): {
        "new_module": "langchain_community.document_loaders.lakefs",
        "name": "LakeFSClient",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.onenote", "OneNoteLoader"): {
        "new_module": "langchain_community.document_loaders.onenote",
        "name": "OneNoteLoader",
        "asname": None,
    },
    ("langchain.document_loaders.mediawikidump", "MWDumpLoader"): {
        "new_module": "langchain_community.document_loaders.mediawikidump",
        "name": "MWDumpLoader",
        "asname": None,
    },
    ("langchain.document_loaders.airtable", "AirtableLoader"): {
        "new_module": "langchain_community.document_loaders.airtable",
        "name": "AirtableLoader",
        "asname": None,
    },
    ("langchain.document_loaders.generic", "GenericLoader"): {
        "new_module": "langchain_community.document_loaders.generic",
        "name": "GenericLoader",
        "asname": None,
    },
    ("langchain.document_loaders.quip", "QuipLoader"): {
        "new_module": "langchain_community.document_loaders.quip",
        "name": "QuipLoader",
        "asname": None,
    },
    ("langchain.document_loaders.discord", "DiscordChatLoader"): {
        "new_module": "langchain_community.document_loaders.discord",
        "name": "DiscordChatLoader",
        "asname": None,
    },
    ("langchain.document_loaders.html", "UnstructuredHTMLLoader"): {
        "new_module": "langchain_community.document_loaders.html",
        "name": "UnstructuredHTMLLoader",
        "asname": None,
    },
    ("langchain.document_loaders.sitemap", "SitemapLoader"): {
        "new_module": "langchain_community.document_loaders.sitemap",
        "name": "SitemapLoader",
        "asname": None,
    },
    ("langchain.document_loaders.mongodb", "MongodbLoader"): {
        "new_module": "langchain_community.document_loaders.mongodb",
        "name": "MongodbLoader",
        "asname": None,
    },
    ("langchain.document_loaders.fauna", "FaunaLoader"): {
        "new_module": "langchain_community.document_loaders.fauna",
        "name": "FaunaLoader",
        "asname": None,
    },
    ("langchain.document_loaders.unstructured", "UnstructuredAPIFileIOLoader"): {
        "new_module": "langchain_community.document_loaders.unstructured",
    ...
    ("langchain.document_loaders.odt", "UnstructuredODTLoader"): {
        "new_module": "langchain_community.document_loaders.odt",
        "name": "UnstructuredODTLoader",
        "asname": None,
    },
    ("langchain.document_loaders.imsdb", "IMSDbLoader"): {
        "new_module": "langchain_community.document_loaders.imsdb",
        "name": "IMSDbLoader",
        "asname": None,
    },
    (
        ...
        "new_module": "langchain_community.document_loaders.azure_blob_storage_file",
        "name": "AzureBlobStorageFileLoader",
        "asname": None,
    },
    ("langchain.document_loaders.geodataframe", "GeoDataFrameLoader"): {
        "new_module": "langchain_community.document_loaders.geodataframe",
        "name": "GeoDataFrameLoader",
        "asname": None,
    },
    ("langchain.document_loaders.tsv", "UnstructuredTSVLoader"): {
        "new_module": "langchain_community.document_loaders.tsv",
        "name": "UnstructuredTSVLoader",
        "asname": None,
    },
    ("langchain.document_loaders.pdf", "AmazonTextractPDFLoader"): {
        "new_module": "langchain_community.document_loaders.pdf",
        "name": "AmazonTextractPDFLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.open_city_data", "OpenCityDataLoader"): {
        "new_module": "langchain_community.document_loaders.open_city_data",
        "name": "OpenCityDataLoader",
        "asname": None,
    },
    ("langchain.document_loaders.csv_loader", "CSVLoader"): {
        "new_module": "langchain_community.document_loaders.csv_loader",
        "name": "CSVLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.excel", "UnstructuredExcelLoader"): {
        "new_module": "langchain_community.document_loaders.excel",
        "name": "UnstructuredExcelLoader",
        "asname": None,
    },
    ("langchain.document_loaders.google_speech_to_text", "GoogleSpeechToTextLoader"): {
        "new_module": "langchain_community.document_loaders.google_speech_to_text",
        "name": "GoogleSpeechToTextLoader",
        "asname": None,
    },
    ("langchain.document_loaders.evernote", "EverNoteLoader"): {
        "new_module": "langchain_community.document_loaders.evernote",
        "name": "EverNoteLoader",
        "asname": None,
    },
    ("langchain.document_loaders.airbyte_json", "AirbyteJSONLoader"): {
        "new_module": "langchain_community.document_loaders.airbyte_json",
        "name": "AirbyteJSONLoader",
        "asname": None,
    },
    ("langchain.document_loaders.rspace", "RSpaceLoader"): {
        "new_module": "langchain_community.document_loaders.rspace",
        "name": "RSpaceLoader",
        "asname": None,
    },
    ("langchain.document_loaders.url", "UnstructuredURLLoader"): {
        "new_module": "langchain_community.document_loaders.url",
        "name": "UnstructuredURLLoader",
        "asname": None,
    },
    ("langchain.document_loaders.chromium", "AsyncChromiumLoader"): {
        "new_module": "langchain_community.document_loaders.chromium",
        "name": "AsyncChromiumLoader",
        "asname": None,
    },
    ("langchain.document_loaders.url_playwright", "PlaywrightEvaluator"): {
        "new_module": "langchain_community.document_loaders.url_playwright",
        "name": "PlaywrightEvaluator",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.url_playwright", "UnstructuredHtmlEvaluator"): {
        "new_module": "langchain_community.document_loaders.url_playwright",
        "name": "UnstructuredHtmlEvaluator",
        "asname": None,
    },
    (
        ...
        "new_module": "langchain_community.document_loaders.baiducloud_bos_directory",
        "name": "BaiduBOSDirectoryLoader",
        "asname": None,
    },
    ("langchain.document_loaders.rtf", "UnstructuredRTFLoader"): {
        "new_module": "langchain_community.document_loaders.rtf",
        "name": "UnstructuredRTFLoader",
        "asname": None,
    },
    ("langchain.document_loaders.snowflake_loader", "SnowflakeLoader"): {
        "new_module": "langchain_community.document_loaders.snowflake_loader",
        "name": "SnowflakeLoader",
        "asname": None,
    },
    ("langchain.document_loaders.dropbox", "DropboxLoader"): {
        "new_module": "langchain_community.document_loaders.dropbox",
        "name": "DropboxLoader",
        "asname": None,
    },
    ("langchain.document_loaders.mhtml", "MHTMLLoader"): {
        "new_module": "langchain_community.document_loaders.mhtml",
        "name": "MHTMLLoader",
        "asname": None,
    },
    ("langchain.document_loaders.hugging_face_dataset", "HuggingFaceDatasetLoader"): {
        "new_module": "langchain_community.document_loaders.hugging_face_dataset",
        "name": "HuggingFaceDatasetLoader",
        "asname": None,
    },
    ("langchain.document_loaders.powerpoint", "UnstructuredPowerPointLoader"): {
        "new_module": "langchain_community.document_loaders.powerpoint",
        "name": "UnstructuredPowerPointLoader",
        "asname": None,
    },
    ("langchain.document_loaders.readthedocs", "ReadTheDocsLoader"): {
        "new_module": "langchain_community.document_loaders.readthedocs",
        "name": "ReadTheDocsLoader",
        "asname": None,
    },
    ("langchain.document_loaders.duckdb_loader", "DuckDBLoader"): {
        "new_module": "langchain_community.document_loaders.duckdb_loader",
        "name": "DuckDBLoader",
        "asname": None,
    },
    ("langchain.document_loaders.twitter", "TwitterTweetLoader"): {
        "new_module": "langchain_community.document_loaders.twitter",
        "name": "TwitterTweetLoader",
        "asname": None,
    },
    ("langchain.document_loaders.markdown", "UnstructuredMarkdownLoader"): {
        "new_module": "langchain_community.document_loaders.markdown",
        "name": "UnstructuredMarkdownLoader",
        "asname": None,
    },
    ("langchain.document_loaders.assemblyai", "AssemblyAIAudioTranscriptLoader"): {
        "new_module": "langchain_community.document_loaders.assemblyai",
        "name": "AssemblyAIAudioTranscriptLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.tensorflow_datasets", "TensorflowDatasetLoader"): {
        "new_module": "langchain_community.document_loaders.tensorflow_datasets",
        "name": "TensorflowDatasetLoader",
        "asname": None,
    },
    ("langchain.document_loaders.email", "OutlookMessageLoader"): {
        "new_module": "langchain_community.document_loaders.email",
        "name": "OutlookMessageLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.onedrive", "OneDriveLoader"): {
        "new_module": "langchain_community.document_loaders.onedrive",
        "name": "OneDriveLoader",
        "asname": None,
    },
    ("langchain.document_loaders.bilibili", "BiliBiliLoader"): {
        "new_module": "langchain_community.document_loaders.bilibili",
        "name": "BiliBiliLoader",
        "asname": None,
    },
    ("langchain.document_loaders.xorbits", "XorbitsLoader"): {
        "new_module": "langchain_community.document_loaders.xorbits",
        "name": "XorbitsLoader",
        "asname": None,
    },
    ("langchain.document_loaders.text", "TextLoader"): {
        "new_module": "langchain_community.document_loaders.text",
        "name": "TextLoader",
        "asname": None,
    },
    ("langchain.document_loaders.airbyte", "AirbyteCDKLoader"): {
        "new_module": "langchain_community.document_loaders.airbyte",
        "name": "AirbyteCDKLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.sharepoint", "SharePointLoader"): {
        "new_module": "langchain_community.document_loaders.sharepoint",
        "name": "SharePointLoader",
        "asname": None,
    },
    ("langchain.document_loaders.acreom", "AcreomLoader"): {
        "new_module": "langchain_community.document_loaders.acreom",
        "name": "AcreomLoader",
        "asname": None,
    },
    ("langchain.document_loaders.word_document", "Docx2txtLoader"): {
        "new_module": "langchain_community.document_loaders.word_document",
        "name": "Docx2txtLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.chatgpt", "ChatGPTLoader"): {
        "new_module": "langchain_community.document_loaders.chatgpt",
        "name": "ChatGPTLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.python", "PythonLoader"): {
        "new_module": "langchain_community.document_loaders.python",
        "name": "PythonLoader",
        "asname": None,
    },
    ("langchain.document_loaders.etherscan", "EtherscanLoader"): {
        "new_module": "langchain_community.document_loaders.etherscan",
        "name": "EtherscanLoader",
        "asname": None,
    },
    ("langchain.document_loaders.joplin", "JoplinLoader"): {
        "new_module": "langchain_community.document_loaders.joplin",
        "name": "JoplinLoader",
        "asname": None,
    },
    ("langchain.document_loaders.docusaurus", "DocusaurusLoader"): {
        "new_module": "langchain_community.document_loaders.docusaurus",
        "name": "DocusaurusLoader",
        "asname": None,
    },
    ("langchain.document_loaders.url_selenium", "SeleniumURLLoader"): {
        "new_module": "langchain_community.document_loaders.url_selenium",
        "name": "SeleniumURLLoader",
        "asname": None,
    },
    ("langchain.document_loaders.recursive_url_loader", "RecursiveUrlLoader"): {
        "new_module": "langchain_community.document_loaders.recursive_url_loader",
        "name": "RecursiveUrlLoader",
        "asname": None,
    },
    ("langchain.document_loaders.blockchain", "BlockchainDocumentLoader"): {
        "new_module": "langchain_community.document_loaders.blockchain",
        "name": "BlockchainDocumentLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.s3_directory", "S3DirectoryLoader"): {
        "new_module": "langchain_community.document_loaders.s3_directory",
        "name": "S3DirectoryLoader",
        "asname": None,
    },
    ("langchain.document_loaders.diffbot", "DiffbotLoader"): {
        "new_module": "langchain_community.document_loaders.diffbot",
        "name": "DiffbotLoader",
        "asname": None,
    },
    ("langchain.document_loaders.obsidian", "ObsidianLoader"): {
        "new_module": "langchain_community.document_loaders.obsidian",
        "name": "ObsidianLoader",
        "asname": None,
    },
    ("langchain.document_loaders.notion", "NotionDirectoryLoader"): {
        "new_module": "langchain_community.document_loaders.notion",
        "name": "NotionDirectoryLoader",
        "asname": None,
    },
    ("langchain.document_loaders.directory", "DirectoryLoader"): {
        "new_module": "langchain_community.document_loaders.directory",
        "name": "DirectoryLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.larksuite", "LarkSuiteDocLoader"): {
        "new_module": "langchain_community.document_loaders.larksuite",
        "name": "LarkSuiteDocLoader",
        "asname": None,
    },
    ("langchain.document_loaders.org_mode", "UnstructuredOrgModeLoader"): {
        "new_module": "langchain_community.document_loaders.org_mode",
        "name": "UnstructuredOrgModeLoader",
        "asname": None,
    },
    ("langchain.document_loaders.github", "BaseGitHubLoader"): {
        "new_module": "langchain_community.document_loaders.github",
    ...
    ("langchain.document_loaders.onedrive_file", "OneDriveFileLoader"): {
        "new_module": "langchain_community.document_loaders.onedrive_file",
        "name": "OneDriveFileLoader",
        "asname": None,
    },
    ("langchain.document_loaders.bibtex", "BibtexLoader"): {
        "new_module": "langchain_community.document_loaders.bibtex",
        "name": "BibtexLoader",
        "asname": None,
    },
    ("langchain.document_loaders.notebook", "NotebookLoader"): {
        "new_module": "langchain_community.document_loaders.notebook",
        "name": "NotebookLoader",
        "asname": None,
    },
    ("langchain.document_loaders.notebook", "concatenate_cells"): {
        "new_module": "langchain_community.document_loaders.notebook",
        "name": "concatenate_cells",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.browserless", "BrowserlessLoader"): {
        "new_module": "langchain_community.document_loaders.browserless",
        "name": "BrowserlessLoader",
        "asname": None,
    },
    ("langchain.document_loaders.json_loader", "JSONLoader"): {
        "new_module": "langchain_community.document_loaders.json_loader",
        "name": "JSONLoader",
        "asname": None,
    },
    ("langchain.document_loaders.docugami", "DocugamiLoader"): {
        "new_module": "langchain_community.document_loaders.docugami",
        "name": "DocugamiLoader",
        "asname": None,
    },
    ("langchain.document_loaders.reddit", "RedditPostsLoader"): {
        "new_module": "langchain_community.document_loaders.reddit",
        "name": "RedditPostsLoader",
        "asname": None,
    },
    ("langchain.document_loaders.stripe", "StripeLoader"): {
        "new_module": "langchain_community.document_loaders.stripe",
        "name": "StripeLoader",
        "asname": None,
    },
    ("langchain.document_loaders.web_base", "WebBaseLoader"): {
        "new_module": "langchain_community.document_loaders.web_base",
        "name": "WebBaseLoader",
        "asname": None,
    },
    ("langchain.document_loaders.trello", "TrelloLoader"): {
        "new_module": "langchain_community.document_loaders.trello",
        "name": "TrelloLoader",
        "asname": None,
    },
    ("langchain.document_loaders.srt", "SRTLoader"): {
        "new_module": "langchain_community.document_loaders.srt",
        "name": "SRTLoader",
        "asname": None,
    },
    ("langchain.document_loaders.epub", "UnstructuredEPubLoader"): {
        "new_module": "langchain_community.document_loaders.epub",
        "name": "UnstructuredEPubLoader",
        "asname": None,
    },
    ("langchain.document_loaders.iugu", "IuguLoader"): {
        "new_module": "langchain_community.document_loaders.iugu",
        "name": "IuguLoader",
        "asname": None,
    },
    ("langchain.document_loaders.tencent_cos_file", "TencentCOSFileLoader"): {
        "new_module": "langchain_community.document_loaders.tencent_cos_file",
        "name": "TencentCOSFileLoader",
        "asname": None,
    },
    ("langchain.document_loaders.ifixit", "IFixitLoader"): {
        "new_module": "langchain_community.document_loaders.ifixit",
        "name": "IFixitLoader",
        "asname": None,
    },
    ("langchain.document_loaders.helpers", "FileEncoding"): {
        "new_module": "langchain_community.document_loaders.helpers",
        "name": "FileEncoding",
        "asname": None,
    },
    ("langchain.document_loaders.helpers", "detect_file_encodings"): {
        "new_module": "langchain_community.document_loaders.helpers",
        "name": "detect_file_encodings",
        "asname": None,
    },
    ("langchain.document_loaders.gcs_file", "GCSFileLoader"): {
        "new_module": "langchain_community.document_loaders.gcs_file",
        "name": "GCSFileLoader",
        "asname": None,
    },
    ("langchain.document_loaders.nuclia", "NucliaLoader"): {
        "new_module": "langchain_community.document_loaders.nuclia",
        "name": "NucliaLoader",
        "asname": None,
    },
    ("langchain.document_loaders.image", "UnstructuredImageLoader"): {
        "new_module": "langchain_community.document_loaders.image",
        "name": "UnstructuredImageLoader",
        "asname": None,
    },
    ("langchain.document_loaders.apify_dataset", "ApifyDatasetLoader"): {
        "new_module": "langchain_community.document_loaders.apify_dataset",
        "name": "ApifyDatasetLoader",
        "asname": None,
    },
    ("langchain.document_loaders.figma", "FigmaFileLoader"): {
        "new_module": "langchain_community.document_loaders.figma",
        "name": "FigmaFileLoader",
        "asname": None,
    },
    ("langchain.document_loaders.rst", "UnstructuredRSTLoader"): {
        "new_module": "langchain_community.document_loaders.rst",
        "name": "UnstructuredRSTLoader",
        "asname": None,
    },
    ("langchain.document_loaders.image_captions", "ImageCaptionLoader"): {
        "new_module": "langchain_community.document_loaders.image_captions",
        "name": "ImageCaptionLoader",
        "asname": None,
    },
    ("langchain.document_loaders.base", "BaseBlobParser"): {
        "new_module": "langchain_community.document_loaders.base",
        "name": "BaseBlobParser",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.news", "NewsURLLoader"): {
        "new_module": "langchain_community.document_loaders.news",
        "name": "NewsURLLoader",
        "asname": None,
    },
    ("langchain.document_loaders.html_bs", "BSHTMLLoader"): {
        "new_module": "langchain_community.document_loaders.html_bs",
        "name": "BSHTMLLoader",
        "asname": None,
    },
    ("langchain.document_loaders.spreedly", "SpreedlyLoader"): {
        "new_module": "langchain_community.document_loaders.spreedly",
        "name": "SpreedlyLoader",
        "asname": None,
    },
    ("langchain.document_loaders.tencent_cos_directory", "TencentCOSDirectoryLoader"): {
        "new_module": "langchain_community.document_loaders.tencent_cos_directory",
        "name": "TencentCOSDirectoryLoader",
        "asname": None,
    },
    ("langchain.document_loaders.couchbase", "CouchbaseLoader"): {
        "new_module": "langchain_community.document_loaders.couchbase",
        "name": "CouchbaseLoader",
        "asname": None,
    },
    ("langchain.document_loaders.wikipedia", "WikipediaLoader"): {
        "new_module": "langchain_community.document_loaders.wikipedia",
        "name": "WikipediaLoader",
        "asname": None,
    },
    ("langchain.document_loaders.toml", "TomlLoader"): {
        "new_module": "langchain_community.document_loaders.toml",
        "name": "TomlLoader",
        "asname": None,
    },
    ("langchain.document_loaders.psychic", "PsychicLoader"): {
        "new_module": "langchain_community.document_loaders.psychic",
        "name": "PsychicLoader",
        "asname": None,
    },
    ("langchain.document_loaders.gcs_directory", "GCSDirectoryLoader"): {
        "new_module": "langchain_community.document_loaders.gcs_directory",
        "name": "GCSDirectoryLoader",
        "asname": None,
    },
    ("langchain.document_loaders.facebook_chat", "FacebookChatLoader"): {
        "new_module": "langchain_community.document_loaders.facebook_chat",
        "name": "FacebookChatLoader",
        "asname": None,
    },
    ...
    ("langchain.document_loaders.azlyrics", "AZLyricsLoader"): {
        "new_module": "langchain_community.document_loaders.azlyrics",
        "name": "AZLyricsLoader",
        "asname": None,
    },
    ("langchain.graphs.arangodb_graph", "ArangoGraph"): {
        "new_module": "langchain_community.graphs.arangodb_graph",
        "name": "ArangoGraph",
        "asname": None,
    },
    ("langchain.graphs.arangodb_graph", "get_arangodb_client"): {
        "new_module": "langchain_community.graphs.arangodb_graph",
        "name": "get_arangodb_client",
        "asname": None,
    },
    ("langchain.graphs.graph_document", "GraphDocument"): {
        "new_module": "langchain_community.graphs.graph_document",
        "name": "GraphDocument",
        "asname": None,
    },
    ...
    ("langchain.graphs.falkordb_graph", "FalkorDBGraph"): {
        "new_module": "langchain_community.graphs.falkordb_graph",
        "name": "FalkorDBGraph",
        "asname": None,
    },
    ("langchain.graphs.neptune_graph", "NeptuneGraph"): {
        "new_module": "langchain_community.graphs.neptune_graph",
        "name": "NeptuneGraph",
        "asname": None,
    },
    ...
    ("langchain.graphs.nebula_graph", "NebulaGraph"): {
        "new_module": "langchain_community.graphs.nebula_graph",
        "name": "NebulaGraph",
        "asname": None,
    },
    ("langchain.graphs.networkx_graph", "KG_TRIPLE_DELIMITER"): {
        "new_module": "langchain_community.graphs.networkx_graph",
        "name": "KG_TRIPLE_DELIMITER",
        "asname": None,
    },
    ...
    ("langchain.graphs.graph_store", "GraphStore"): {
        "new_module": "langchain_community.graphs.graph_store",
        "name": "GraphStore",
        "asname": None,
    },
    ("langchain.graphs.hugegraph", "HugeGraph"): {
        "new_module": "langchain_community.graphs.hugegraph",
        "name": "HugeGraph",
        "asname": None,
    },
    ("langchain.graphs.memgraph_graph", "MemgraphGraph"): {
        "new_module": "langchain_community.graphs.memgraph_graph",
        "name": "MemgraphGraph",
        "asname": None,
    },
    ("langchain.graphs.neo4j_graph", "Neo4jGraph"): {
        "new_module": "langchain_community.graphs.neo4j_graph",
        "name": "Neo4jGraph",
        "asname": None,
    },
    ("langchain.llms.rwkv", "RWKV"): {
        "new_module": "langchain_community.llms.rwkv",
        "name": "RWKV",
        "asname": None,
    },
    ("langchain.llms.vertexai", "VertexAI"): {
        "new_module": "langchain_community.llms.vertexai",
        "name": "VertexAI",
        "asname": None,
    },
    ...
    ("langchain.llms.tongyi", "Tongyi"): {
        "new_module": "langchain_community.llms.tongyi",
        "name": "Tongyi",
        "asname": None,
    },
    ("langchain.llms.amazon_api_gateway", "AmazonAPIGateway"): {
        "new_module": "langchain_community.llms.amazon_api_gateway",
        "name": "AmazonAPIGateway",
        "asname": None,
    },
    ("langchain.llms.octoai_endpoint", "OctoAIEndpoint"): {
        "new_module": "langchain_community.llms.octoai_endpoint",
        "name": "OctoAIEndpoint",
        "asname": None,
    },
    ("langchain.llms.deepsparse", "DeepSparse"): {
        "new_module": "langchain_community.llms.deepsparse",
        "name": "DeepSparse",
        "asname": None,
    },
    ...
    ("langchain.llms.loading", "load_llm"): {
        "new_module": "langchain_community.llms.loading",
        "name": "load_llm",
        "asname": None,
    },
    ("langchain.llms.loading", "load_llm_from_config"): {
        "new_module": "langchain_community.llms.loading",
        "name": "load_llm_from_config",
        "asname": None,
    },
    ("langchain.llms.azureml_endpoint", "AzureMLEndpointClient"): {
        "new_module": "langchain_community.llms.azureml_endpoint",
        "name": "AzureMLEndpointClient",
        "asname": None,
    },
    ...
    ("langchain.llms.azureml_endpoint", "OSSContentFormatter"): {
        "new_module": "langchain_community.llms.azureml_endpoint",
        "name": "OSSContentFormatter",
        "asname": None,
    },
    ("langchain.llms.google_palm", "GooglePalm"): {
        "new_module": "langchain_community.llms.google_palm",
        "name": "GooglePalm",
        "asname": None,
    },
    ("langchain.llms.vllm", "VLLM"): {
        "new_module": "langchain_community.llms.vllm",
        "name": "VLLM",
        "asname": None,
    },
    ...
    ("langchain.llms.ctransformers", "CTransformers"): {
        "new_module": "langchain_community.llms.ctransformers",
        "name": "CTransformers",
        "asname": None,
    },
    ("langchain.llms.fake", "FakeListLLM"): {
        "new_module": "langchain_community.llms.fake",
        "name": "FakeListLLM",
        "asname": None,
    },
    ...
    ("langchain.llms.minimax", "Minimax"): {
        "new_module": "langchain_community.llms.minimax",
        "name": "Minimax",
        "asname": None,
    },
    ("langchain.llms.mlflow", "Mlflow"): {
        "new_module": "langchain_community.llms.mlflow",
        "name": "Mlflow",
        "asname": None,
    },
    ("langchain.llms.huggingface_pipeline", "HuggingFacePipeline"): {
        "new_module": "langchain_community.llms.huggingface_pipeline",
        "name": "HuggingFacePipeline",
        "asname": None,
    },
    ("langchain.llms.manifest", "ManifestWrapper"): {
        "new_module": "langchain_community.llms.manifest",
        "name": "ManifestWrapper",
        "asname": None,
    },
    ("langchain.llms.promptlayer_openai", "PromptLayerOpenAI"): {
        "new_module": "langchain_community.llms.promptlayer_openai",
    ...
    ("langchain.llms.chatglm", "ChatGLM"): {
        "new_module": "langchain_community.llms.chatglm",
        "name": "ChatGLM",
        "asname": None,
    },
    ("langchain.llms.pipelineai", "PipelineAI"): {
        "new_module": "langchain_community.llms.pipelineai",
        "name": "PipelineAI",
        "asname": None,
    },
    ("langchain.llms.replicate", "Replicate"): {
        "new_module": "langchain_community.llms.replicate",
        "name": "Replicate",
        "asname": None,
    },
    ("langchain.llms.mlflow_ai_gateway", "MlflowAIGateway"): {
        "new_module": "langchain_community.llms.mlflow_ai_gateway",
        "name": "MlflowAIGateway",
        "asname": None,
    },
    ("langchain.llms.petals", "Petals"): {
        "new_module": "langchain_community.llms.petals",
        "name": "Petals",
        "asname": None,
    },
    ("langchain.llms.gooseai", "GooseAI"): {
        "new_module": "langchain_community.llms.gooseai",
        "name": "GooseAI",
        "asname": None,
    },
    ("langchain.llms.anyscale", "Anyscale"): {
        "new_module": "langchain_community.llms.anyscale",
        "name": "Anyscale",
        "asname": None,
    },
    ...
    ("langchain.llms.arcee", "Arcee"): {
        "new_module": "langchain_community.llms.arcee",
        "name": "Arcee",
        "asname": None,
    },
    ("langchain.llms.javelin_ai_gateway", "JavelinAIGateway"): {
        "new_module": "langchain_community.llms.javelin_ai_gateway",
        "name": "JavelinAIGateway",
        "asname": None,
    },
    ...
    ("langchain.llms.cloudflare_workersai", "CloudflareWorkersAI"): {
        "new_module": "langchain_community.llms.cloudflare_workersai",
        "name": "CloudflareWorkersAI",
        "asname": None,
    },
    ("langchain.llms.ctranslate2", "CTranslate2"): {
        "new_module": "langchain_community.llms.ctranslate2",
        "name": "CTranslate2",
        "asname": None,
    },
    ("langchain.llms.aleph_alpha", "AlephAlpha"): {
        "new_module": "langchain_community.llms.aleph_alpha",
        "name": "AlephAlpha",
        "asname": None,
    },
    ("langchain.llms.human", "HumanInputLLM"): {
        "new_module": "langchain_community.llms.human",
        "name": "HumanInputLLM",
        "asname": None,
    },
    ("langchain.llms.openlm", "OpenLM"): {
        "new_module": "langchain_community.llms.openlm",
        "name": "OpenLM",
        "asname": None,
    },
    ("langchain.llms.forefrontai", "ForefrontAI"): {
        "new_module": "langchain_community.llms.forefrontai",
        "name": "ForefrontAI",
        "asname": None,
    },
    ("langchain.llms.gpt4all", "GPT4All"): {
        "new_module": "langchain_community.llms.gpt4all",
        "name": "GPT4All",
        "asname": None,
    },
    ("langchain.llms.nlpcloud", "NLPCloud"): {
        "new_module": "langchain_community.llms.nlpcloud",
        "name": "NLPCloud",
        "asname": None,
    },
    ("langchain.llms.huggingface_text_gen_inference", "HuggingFaceTextGenInference"): {
        "new_module": "langchain_community.llms.huggingface_text_gen_inference",
        "name": "HuggingFaceTextGenInference",
        "asname": None,
    },
    ("langchain.llms.openai", "AzureOpenAI"): {
        "new_module": "langchain_community.llms.openai",
        "name": "AzureOpenAI",
        "asname": None,
    },
    ...
    ("langchain.llms.koboldai", "KoboldApiLLM"): {
        "new_module": "langchain_community.llms.koboldai",
        "name": "KoboldApiLLM",
        "asname": None,
    },
    ("langchain.llms.cerebriumai", "CerebriumAI"): {
        "new_module": "langchain_community.llms.cerebriumai",
        "name": "CerebriumAI",
        "asname": None,
    },
    ("langchain.llms.volcengine_maas", "VolcEngineMaasBase"): {
        "new_module": "langchain_community.llms.volcengine_maas",
        "name": "VolcEngineMaasBase",
        "asname": None,
    },
    ...
    ("langchain.llms.utils", "enforce_stop_tokens"): {
        "new_module": "langchain_community.llms.utils",
        "name": "enforce_stop_tokens",
        "asname": None,
    },
    ("langchain.llms.mosaicml", "MosaicML"): {
        "new_module": "langchain_community.llms.mosaicml",
        "name": "MosaicML",
        "asname": None,
    },
    ("langchain.llms.pai_eas_endpoint", "PaiEasEndpoint"): {
        "new_module": "langchain_community.llms.pai_eas_endpoint",
        "name": "PaiEasEndpoint",
        "asname": None,
    },
    ("langchain.llms.fireworks", "Fireworks"): {
        "new_module": "langchain_community.llms.fireworks",
        "name": "Fireworks",
        "asname": None,
    },
    ("langchain.llms.openllm", "OpenLLM"): {
        "new_module": "langchain_community.llms.openllm",
        "name": "OpenLLM",
        "asname": None,
    },
    ("langchain.llms.bittensor", "NIBittensorLLM"): {
        "new_module": "langchain_community.llms.bittensor",
        "name": "NIBittensorLLM",
        "asname": None,
    },
    ("langchain.llms.stochasticai", "StochasticAI"): {
        "new_module": "langchain_community.llms.stochasticai",
        "name": "StochasticAI",
        "asname": None,
    },
    ("langchain.llms.sagemaker_endpoint", "LLMContentHandler"): {
        "new_module": "langchain_community.llms.sagemaker_endpoint",
        "name": "LLMContentHandler",
        "asname": None,
    },
    ...
    ("langchain.llms.baseten", "Baseten"): {
        "new_module": "langchain_community.llms.baseten",
        "name": "Baseten",
        "asname": None,
    },
    ("langchain.llms.anthropic", "Anthropic"): {
        "new_module": "langchain_community.llms.anthropic",
        "name": "Anthropic",
        "asname": None,
    },
    ("langchain.llms.deepinfra", "DeepInfra"): {
        "new_module": "langchain_community.llms.deepinfra",
        "name": "DeepInfra",
        "asname": None,
    },
    ("langchain.llms.symblai_nebula", "Nebula"): {
        "new_module": "langchain_community.llms.symblai_nebula",
        "name": "Nebula",
        "asname": None,
    },
    ("langchain.llms.xinference", "Xinference"): {
        "new_module": "langchain_community.llms.xinference",
        "name": "Xinference",
        "asname": None,
    },
    ("langchain.llms.titan_takeoff_pro", "TitanTakeoffPro"): {
        "new_module": "langchain_community.llms.titan_takeoff_pro",
        "name": "TitanTakeoffPro",
        "asname": None,
    },
    ("langchain.llms.textgen", "TextGen"): {
        "new_module": "langchain_community.llms.textgen",
        "name": "TextGen",
        "asname": None,
    },
    ("langchain.llms.modal", "Modal"): {
        "new_module": "langchain_community.llms.modal",
        "name": "Modal",
        "asname": None,
    },
    ("langchain.llms.writer", "Writer"): {
        "new_module": "langchain_community.llms.writer",
        "name": "Writer",
        "asname": None,
    },
    ("langchain.llms.together", "Together"): {
        "new_module": "langchain_community.llms.together",
        "name": "Together",
        "asname": None,
    },
    ("langchain.llms.gradient_ai", "GradientLLM"): {
        "new_module": "langchain_community.llms.gradient_ai",
        "name": "GradientLLM",
        "asname": None,
    },
    ...
    ("langchain.llms.watsonxllm", "WatsonxLLM"): {
        "new_module": "langchain_community.llms.watsonxllm",
        "name": "WatsonxLLM",
        "asname": None,
    },
    ("langchain.llms.bananadev", "Banana"): {
        "new_module": "langchain_community.llms.bananadev",
        "name": "Banana",
        "asname": None,
    },
    ("langchain.llms.databricks", "Databricks"): {
        "new_module": "langchain_community.llms.databricks",
        "name": "Databricks",
        "asname": None,
    },
    ("langchain.llms.ai21", "AI21"): {
        "new_module": "langchain_community.llms.ai21",
        "name": "AI21",
        "asname": None,
    },
    ("langchain.llms.ai21", "AI21PenaltyData"): {
        "new_module": "langchain_community.llms.ai21",
        "name": "AI21PenaltyData",
        "asname": None,
    },
    ("langchain.llms.self_hosted_hugging_face", "SelfHostedHuggingFaceLLM"): {
        "new_module": "langchain_community.llms.self_hosted_hugging_face",
        "name": "SelfHostedHuggingFaceLLM",
        "asname": None,
    },
    ("langchain.llms.beam", "Beam"): {
        "new_module": "langchain_community.llms.beam",
        "name": "Beam",
        "asname": None,
    },
    ("langchain.llms.clarifai", "Clarifai"): {
        "new_module": "langchain_community.llms.clarifai",
        "name": "Clarifai",
        "asname": None,
    },
    ("langchain.llms.predictionguard", "PredictionGuard"): {
        "new_module": "langchain_community.llms.predictionguard",
        "name": "PredictionGuard",
        "asname": None,
    },
    ("langchain.llms.edenai", "EdenAI"): {
        "new_module": "langchain_community.llms.edenai",
        "name": "EdenAI",
        "asname": None,
    },
    ("langchain.llms.baidu_qianfan_endpoint", "QianfanLLMEndpoint"): {
        "new_module": "langchain_community.llms.baidu_qianfan_endpoint",
        "name": "QianfanLLMEndpoint",
        "asname": None,
    },
    ("langchain.llms.cohere", "Cohere"): {
        "new_module": "langchain_community.llms.cohere",
        "name": "Cohere",
        "asname": None,
    },
    ("langchain.llms.ollama", "Ollama"): {
        "new_module": "langchain_community.llms.ollama",
        "name": "Ollama",
        "asname": None,
    },
    ("langchain.llms.gigachat", "GigaChat"): {
        "new_module": "langchain_community.llms.gigachat",
        "name": "GigaChat",
        "asname": None,
    },
    ("langchain.llms.bedrock", "Bedrock"): {
        "new_module": "langchain_community.llms.bedrock",
        "name": "Bedrock",
        "asname": None,
    },
    ...
    ("langchain.llms.predibase", "Predibase"): {
        "new_module": "langchain_community.llms.predibase",
        "name": "Predibase",
        "asname": None,
    },
    ("langchain.llms.opaqueprompts", "OpaquePrompts"): {
        "new_module": "langchain_community.llms.opaqueprompts",
        "name": "OpaquePrompts",
        "asname": None,
    },
    ("langchain.llms.titan_takeoff", "TitanTakeoff"): {
        "new_module": "langchain_community.llms.titan_takeoff",
        "name": "TitanTakeoff",
        "asname": None,
    },
    ("langchain.llms.aviary", "Aviary"): {
        "new_module": "langchain_community.llms.aviary",
        "name": "Aviary",
        "asname": None,
    },
    ("langchain.llms.llamacpp", "LlamaCpp"): {
        "new_module": "langchain_community.llms.llamacpp",
        "name": "LlamaCpp",
        "asname": None,
    },
    ("langchain.llms.huggingface_hub", "HuggingFaceHub"): {
        "new_module": "langchain_community.llms.huggingface_hub",
        "name": "HuggingFaceHub",
        "asname": None,
    },
    ...
    ("langchain.indexes._api", "BaseLoader"): {
        "new_module": "langchain_community.document_loaders.base",
        "name": "BaseLoader",
        "asname": None,
    },
