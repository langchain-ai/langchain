...
export default function Feedback() {
  ...
  const newGithubIssueURL = pathname
    ? `https://github.com/langchain-ai/langchain/issues/new?assignees=&labels=03+-+Documentation&projects=&template=documentation.yml&title=DOC%3A+%3CIssue+related+to+${pathname}%3E&url=${pathname}`
