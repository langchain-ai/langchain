...
![Screenshot of the LangSmith debugging interface showing an AgentExecutor run with input and output details, and a run tree visualization.](/img/run_details.png "LangSmith Debugging Interface")
