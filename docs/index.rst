...
- `Gallery <https://github.com/kyrolabs/awesome-langchain>`_: A great collection by the folks at `Kyrolabs <https://kyrolabs.com>`_ of projects that use LangChain. Useful for finding inspiration and example implementations.
