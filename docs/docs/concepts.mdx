...
![Diagram of a complete tool calling flow](/img/tool_calling_flow)
...
- [LangGraph quickstart building an agent](https://langchain-ai.github.io/langgraph/tutorials/introduction/)
