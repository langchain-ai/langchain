...
Multimodal models are still a fairly new concept and model providers are taking different approaches.
As such, we've kept our abstractions around multimodal fairly light weight.
Models that support multimodal inputs should support it in the OpenAI format.
