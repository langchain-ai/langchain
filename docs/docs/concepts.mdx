...
Therefore, AI agents need robust memory systems that support multi-modality, offer strong operational performance, and enable agent memory sharing as well as separation, while ensuring [speed, scale, and simplicity](https://learn.microsoft.com/en-us/azure/cosmos-db/ai-agents#building-a-robust-ai-agent-memory-system).

Read more about [AI agents](https://learn.microsoft.com/en-us/azure/cosmos-db/ai-agents).
