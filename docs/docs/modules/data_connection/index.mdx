...
**[Indexes](/docs/modules/data_connection/indexing)**

**Index** is used to avoid writing duplicated content into the 
vectostore and to avoid over-writing content if it’s unchanged.