...
| [Integration: AI21 Semantic](/docs/integrations/document_transformers/ai21_semantic_text_splitter/) | Semantics             |    ✅           | Identifies distinct topics that form coherent pieces of text and splits along those. |
| [Integration: semantic_text_splitter](/docs/integrations/document_transformers/semantic_text_splitter/) | Sentences                     |               | Splits text based on the `semantic_text_splitter` package.                                                                                                              |
