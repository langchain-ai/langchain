...
| Semantic Text Splitter]|[Integration: semantic_text_splitter](/docs/integrations/document_transformers/semantic_text_splitter/)                                                                                                                                            | Sentences                     |               | Splits text based on the `semantic_text_splitter` package.
