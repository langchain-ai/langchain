...
guide](/docs/guides/modules/chat_models/structured_output).
...
-   **Output parsing**: See [OpenAI Tools output
    ...
    various formats.
-   **Structured output chains**: [Some models have constructors](/docs/guides/modules/chat_models/structured_output) that
