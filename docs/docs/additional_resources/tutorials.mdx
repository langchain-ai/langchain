...
### Neo4j GraphAcademy
- [Build a Neo4j-backed Chatbot using Python](https://graphacademy.neo4j.com/courses/llm-chatbot-python/?ref=langchain)


---------------------
⛓ icon marks a new addition [last update 2024-02-29]
