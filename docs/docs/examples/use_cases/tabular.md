...
other text/unstructured data. For this, you should use a document loader like the [CSVLoader](../modules/indexes/document_loaders/examples/csv.html)
and then you should [create an index](../modules/indexes.rst) over that data, and [query it that way](../modules/chains/index_examples/vector_db_qa.html).
...
- [SQL Database Chain](../modules/chains/how_to/sqlite.html)
...
- [SQL Agent](../modules/agents/tools/toolkits/examples/sql_database.html)
- [Pandas Agent](../modules/agents/tools/toolkits/examples/pandas.html)
- [CSV Agent](../modules/agents/tools/toolkits/examples/csv.html)
