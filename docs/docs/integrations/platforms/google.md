...
> [AlloyDB](https://cloud.google.com/alloydb) is a fully managed relational database service that offers high performance, seamless integration, and impressive scalability. AlloyDB is 100% compatible with PostgreSQL.
...
See [usage example](/docs/integrations/memory/alloydb_vector_store).
...
See [usage example](/docs/integrations/memory/alloydb_document_loader).
...
See [usage example](/docs/integrations/memory/alloydb_chat_message_history).
