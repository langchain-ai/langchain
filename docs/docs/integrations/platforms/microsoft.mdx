...
[AI agents](https://learn.microsoft.com/en-us/azure/cosmos-db/ai-agents) need robust memory systems that support multi-modality, offer strong operational performance, and enable agent memory sharing as well as separation.
