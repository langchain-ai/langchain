...
See [detail configuration instructions](/docs/integrations/vectorstores/azure_cosmos_db_mongo_vcore).
...
See a [usage example](/docs/integrations/vectorstores/azure_cosmos_db_mongo_vcore).
