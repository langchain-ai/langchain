...
2. [Azure AI](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/deploy-models) - Offers access to a variety of models from different providers including Azure OpenAI, DeepSeek, Cohere, Phi and Mistral through a unified API.
