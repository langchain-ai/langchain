...
See [detail configuration instructions](/docs/integrations/vectorstores/azuresqldb).

We need to install `langchain-sqlserver` python package.
...
See a [usage example](/docs/integrations/vectorstores/azuresqldb).
