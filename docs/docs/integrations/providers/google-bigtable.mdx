...
Bigtable is a scalable, fully managed NoSQL wide-column database suitable for both real-time access and analytics workloads. This page provides an overview of Bigtable's LangChain integrations.
...
This project is licensed under the Apache 2.0 License - see the LICENSE file in the [package repo](https://github.com/googleapis/langchain-google-bigtable-python/) for details.
