...
This page lists the integrations available with [Astra DB](https://astra.datastax.com) and [Apache Cassandra®](https://cassandra.apache.org/).
...
> DataStax Astra DB is a serverless vector-capable database built on Cassandra and made conveniently available
...
## Apache Cassandra and CQL-compatible Astra DB
...
> DataStax [CQL-compatible Astra DB](https://astra.datastax.com) is a managed serverless database built on Cassandra, offering the same interface and strengths.
