...
Vectara also provides a full RAG pipeline, including generative summarization. 
...
* [this notebook](/docs/integrations/retreivers/self_query/vectara_self_query.html) shows the self-query capability with Vectara.
