...
|Rerank Retriever|Rank strings based on relevance|[rerank](https://docs.predictionguard.com/api-reference/api-reference/rerank)|`from langchain.retrievers.document_compressors import PredictionGuardRerank`|[PredictionGuardRerank.ipynb](/docs/integrations/retrievers/PredictionGuardRerank)|
