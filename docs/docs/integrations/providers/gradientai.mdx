...
You can simply create an account in DigitalOcean, get DIGITALOCEAN_INFERENCE_KEY API key from Gradient Platform, and install the `langchain-gradient` integration package.
