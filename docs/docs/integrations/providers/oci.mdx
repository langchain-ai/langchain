...
See [chat](/docs/integrations/llms/oci_generative_ai.ipynb), [complete](/docs/integrations/chat/oci_generative_ai.ipynb), and [embedding](/docs/integrations/text_embedding/oci_generative_ai.ipynb) usage examples.
