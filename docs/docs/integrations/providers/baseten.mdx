...
>**Model APIs** (recommended): For access to the latest, most popular opensource models. All models can be accessed
through a slug via OpenAI-compatible endpoints. Simply choose one of the following
...
>**Dedicated URLs**: Use specific model deployments with dedicated resources by providing a `model_url`
parameter. This gives you dedicated GPU resources and consistent SLAs for your custom models.
