...
| Retriever | Source | PyPI Package | Latest Version | Project Page |
| :--- | :--- | :---: | :---: | :---: |
| [Graph RAG](/docs/integrations/retrievers/graph_rag) | [github.com/datastax/graph-rag](https://github.com/datastax/graph-rag) | [langchain-graph-retriever](https://pypi.org/project/langchain-graph-retriever/) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-graph-retriever?style=plastic&label=%20&color=6b1c96) | [Graph RAG](https://datastax.github.io/graph-rag/) |
...
This section shows how to populate a variety of vector stores with the animal data.
...
<Tabs groupId="vector-store" queryString>
  <TabItem value="astra-db" label="AstraDB" default>
    <div style={{ paddingLeft: '30px' }}>
      Install the langchain-graph-retriever with the Astra extra:
      ```bash
  ...
  <TabItem value="cassandra" label="Apache Cassandra">
    <div style={{ paddingLeft: '30px' }}>
      Install the langchain-graph-retriever with the Cassandra extra:
      ```bash
  ...
  <TabItem value="opensearch" label="OpenSearch">
    <div style={{ paddingLeft: '30px' }}>
      Install the langchain-graph-retriever with the OpenSearch extra:
      ```bash
  ...
  <TabItem value="chroma" label="Chroma">
    <div style={{ paddingLeft: '30px' }}>
      Install the langchain-graph-retriever with the Chroma extra:
      ```bash
