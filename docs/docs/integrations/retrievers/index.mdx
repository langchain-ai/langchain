...
|-----------|--------|---------|
| [ArxivRetriever](/docs/integrations/retrievers/arxiv) | Internet search | [langchain_community](https://api.python.langchain.com/en/latest/retrievers/langchain_community.retrievers.tavily_search_api.TavilySearchAPIRetriever.html) |
| [TavilySearchAPIRetriever](/docs/integrations/retrievers/tavily) | Scholarly articles on [arxiv.org](https://arxiv.org/) | [langchain_community](https://api.python.langchain.com/en/latest/retrievers/langchain_community.retrievers.arxiv.ArxivRetriever.html) |
