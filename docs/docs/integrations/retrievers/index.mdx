...
| [TavilySearchAPIRetriever](/docs/integrations/retrievers/tavily) | ❌ | ❌ | [langchain_community.retrievers](https://api.python.langchain.com/en/latest/retrievers/langchain_community.retrievers.tavily_search_api.TavilySearchAPIRetriever.html) |
