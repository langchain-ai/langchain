...
See integrations [here](/docs/integrations/chat/).

  </TabItem>
  <TabItem value="embedding_models" label="Embedding models">
...
See integrations [here](/docs/integrations/text_embedding/).
...
<VectorStoreTabs useFakeEmbeddings={true} />

See integrations [here](/docs/integrations/vectorstores/).
...
def get_info(query: str) -> str:
    """Get information from external resource.

    Args:
        query: (str) search query

    Returns: (str) retrieved information.
    """
    pass
```

See integrations and built-in tools [here](/docs/integrations/tools/).
...
The LangChain framework consists of the following open-source libraries:
