...
- [How to: split HTML | Choosing a splitter](/docs/how_to/splitting_html)
- [How to: split HTML | Split by headers](/docs/how_to/HTML_header_metadata_splitter)
- [How to: split HTML | Split by sections](/docs/how_to/HTML_section_aware_splitter)
- [How to: split HTML | Split by header and preserve elements](/docs/how_to/HTML_Semantic_Preserving_Splitter)
