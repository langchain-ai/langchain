...
[Messages](/docs/concepts/#messages) are a communication with some content and a role that describes the source of the message. Messages are the input and output of chat models.
