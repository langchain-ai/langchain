...
- [How to: Response metadata](/docs/how_to/response_metadata)
...
- [How to: Text embedding models](/docs/how_to/embed_text)
- [How to: Caching](/docs/how_to/caching_embeddings)
...
- [How to: Hybrid Search](/docs/how_to/hybrid)
...
- [How to: Build an Agent with AgentExecutor (Legacy)](/docs/how_to/agent_executor)
...
- [How to: create a custom chat model class](/docs/how_to/custom_chat_model)
- [How to: create a custom LLM class](/docs/how_to/custom_llm)
- [How to: create a custom Retriever](/docs/how_to/custom_retriever)
- [How to: write a custom Document Loader](/docs/how_to/document_loader_custom)
- [How to: write a custom Output Parser](/docs/how_to/output_parser_custom)
- [How to: create tools](/docs/how_to/custom_callbacks)
...
- [How to: deal with high cardinality categorical variables when doing query analysis](/docs/how_to/query_high_cardinality)
