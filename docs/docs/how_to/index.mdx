...
For a quick overview of how to use the main LCEL primitives check out the [LCEL Cheatsheet](/docs/how_to/lcel_cheatsheet/).

- [How to: chain runnables](/docs/how_to/sequence)
- [How to: stream runnables](/docs/how_to/streaming)
- [How to: invoke runnables in parallel](/docs/how_to/parallel/)
- [How to: set default runnable inputs](/docs/how_to/binding/)
...
- [How to: create a dynamic (self-constructing) chain](/docs/how_to/dynamic/)
