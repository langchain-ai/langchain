...
The `HTMLSectionSplitter` is designed for documents with a clear hierarchical structure defined by HTML headers like `h1`, `h2`, etc. It ensures that related content is grouped together semantically according to the document’s structure.
  ...
  return (
    <iframe srcDoc={`
      ...
      <body>
        ...
        <video controls width='250' src='https://www.w3schools.com/html/mov_bbb.mp4' type='video/mp4'>
