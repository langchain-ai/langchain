...
| langchain-experimental                 | 0.1.0   | >=0.1,<0.2                 |

### Integration packages

| Package                                | Latest  | Recommended constraint     |
| -------------------------------------- | ------- | -------------------------- |
| langchain-airbyte                      | 0.2.0   | >=0.2,<0.3                 |  # TODO: delete
...
| langchain-couchbase                    | 0.2.0   | >=0.2,<0.3                 |  # TODO: delete
...
| langchain-robocorp                     | 0.1.0   | >=0.1,<0.2                 |
| langchain-unstructured                 | 0.2.0   | >=0.2,<0.3                 |
