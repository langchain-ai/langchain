...
1. Managing conversation history. For example, keep only the last `n` turns of the conversation between the user and the AI.
...
The extracted information can then be saved into an appropriate data structure (e.g., a dictionary), and information from it can be retrieved and injected
