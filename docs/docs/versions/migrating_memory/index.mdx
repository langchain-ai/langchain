...
Where relevant we will also show how to implement the same functionality using just [LCEL](/docs/concepts/#langchain-expression-language-lcel) without LangGraph; however, we recommend that using LangGraph if persistence is required.
