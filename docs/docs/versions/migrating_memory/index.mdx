...
| `VectorStoreRetrieverMemory`      | See related [long-term memory agent tutorial](https://langchain-ai.github.io/langgraph/tutorials/memory/long_term_memory_agent/#adding-structured-memories) | Stores the conversation history in a vector store and retrieves the most relevant parts of past conversation based on the input.                                                                                    |
