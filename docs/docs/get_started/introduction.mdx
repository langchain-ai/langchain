...
- **Development**: Write your applications using LangChain's robust building blocks and flexible components. Hit the ground running using [third-party integrations](/docs/integrations/platforms/) and [LangChain Templates](/docs/templates).
