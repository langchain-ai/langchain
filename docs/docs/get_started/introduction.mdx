...
**LangChain** the Python package is a framework for developing applications powered by language models. It enables applications that:
...
LangChain the Python package is just one part of the LangChain ecosystem. The other elements of the stack are:

- **[LangChain.js](https://js.langchain.com)**: The JavaScript/TypeScript version of LangChain. We aim to keep LangChain.js and LangChain in sync as much as possible. In particular, the two libraries share a serialization scheme, allowing you to share serializable objects across them.
