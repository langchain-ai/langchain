...
- **Development**: Write your applications using LangChain's [robust building blocks](/docs/expression_language/get_started) and [flexible components](/docs/modules). Hit the ground running using [third-party integrations](/docs/integrations/platforms/) and [LangChain Templates](/docs/templates).
- **Productionization**: Use [LangSmith](/docs/langsmith) to inspect, test and evaluate your chains, so that you can constantly improve and deploy with confidence.
