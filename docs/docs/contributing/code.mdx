...
- Partner integrations: Partner packages in `libs/partners` that are independently verison controlled.
...
There are also [integration tests and code-coverage](./reference/testing) available.
