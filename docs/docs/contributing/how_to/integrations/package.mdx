...
Embeddings are used to convert `Document` objects, which currently represent their
`document.page_content` as a string, into a vector representation (represented
as a list of floats).
...
| Method/Property         | Description                                          |
|------------------------ |------------------------------------------------------|
| `__init__`              | Initialize the embeddings object.                    |
| `embed_query`           | Embed a list of texts. (required)                    |
| `embed_documents`       | Embed a list of documents.                           |
| `aembed_query`          | Asynchronously embed a list of texts.                |
