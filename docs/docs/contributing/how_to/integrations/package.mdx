...
import EmbeddingsSource from '!!raw-loader!/../../../../libs/cli/langchain_cli/integration_template/integration_template/embeddings.py';
    ...
    <TabItem value="document_loaders" label="Document loaders">
