...
import ChatSource from '!!raw-loader!/../../../../libs/cli/langchain_cli/integration_template/integration_template/chat_models.py';

<CodeBlock language="jsx">
    {
        ChatSource.replaceAll('__ModuleName__', 'ParrotLink')
