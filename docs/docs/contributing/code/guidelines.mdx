...
We encourage and appreciate bug fixes. We ask that you:

- Explain the bug in enough detail for maintainers to reproduce it.
...
We aim to keep the bar high for new features. We generally don't accept new core abstractions, changes to infrastructures and dependencies,
new agents/chains from external contributors without an existing GitHub discussion or issue that demonstrates an acute need for them.
