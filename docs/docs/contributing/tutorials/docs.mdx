...
2. **Fork the repository:**
   ...
   - Make sure to fork the repository into your **personal account and not an organization** ([why?](../faq.mdx#how-do-i-allow-maintainers-to-edit-my-pr)).
...
For more information on reviews, see the [Review Process](../review_process.mdx).
