...
Under this framework, all documentation falls under one of four categories: Tutorials, How-to guides,
...
- The first time you mention a LangChain concept, use its full name (e.g. "LangChain Expression Language (LCEL)"), and link to its conceptual/other documentation page
  - It's also helpful to add a prerequisite callout that links to any pages that contain necessary background information
...
LangChain's conceptual guides fall under the **Explanation** quadrant of Diataxis. They should cover LangChain terms and concepts
