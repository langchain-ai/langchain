...
## Get started
- [Chat models](/docs/tutorials/chat_models): Get started with LLMs.
- [Embedding models](/docs/tutorials/embeddings): Get started with embeddings to vectorize text, images, and other media.
- [Vector stores](/docs/tutorials/retrievers): Get started with vectorstores to save and manage your embeddings.
