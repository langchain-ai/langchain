...
1. **Standardized and enhanced component interfaces:** The growing number of [models](/docs/integrations/chat/) and [related components](/docs/integrations/vectorstores/) for AI applications has resulted in a wide variety of different APIs that developers need to learn and use.
...
LangChain also enhances the base components with capabilities that make them more practical for building LLM applications (like streaming, async, and batch support)
...
## Standardized and enhanced component interfaces
