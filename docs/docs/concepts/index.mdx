...
export const RedirectAnchors = () => {
    ...
    const lookup = {
        ...
        { source="#fewshot-prompting", destination="/docs/concepts/few_shot_prompting" },
        ...
        { source="#query-translation", destination="/docs/concepts/retrieval/#query-re-writing" },
        { source="#routing", destination="/docs/concepts/" },
