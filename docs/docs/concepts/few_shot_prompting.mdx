...
Generally, selecting by semantic similarity leads to the best model performance. But how important this is again model and task specific, and is something worth experimenting with.
