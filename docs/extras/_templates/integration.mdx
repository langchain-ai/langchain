...
See a [usage example](/docs/modules/data_io/text_embedding/integrations/INCLUDE_REAL_NAME.html)
...
See a [usage example](/docs/modules/data_io/document_loaders/integrations/INCLUDE_REAL_NAME.html).
