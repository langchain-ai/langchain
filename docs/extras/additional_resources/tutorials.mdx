...
- [`PrivateGPT`: Chat to your FILES OFFLINE and FREE [Installation and Tutorial]](https://youtu.be/G7iLllmx4qc) 
- ⛓ [`SmartGPT`: Make ChatGPT Smarter](https://youtu.be/bbnpu2BQ12s?si=u7r7lREnXeox1dJO)
- ⛓ [`CODE-LLAMA` For Talking to Code Base and Documentation](https://youtu.be/aD-u0gl93wM?si=d6BkBht9SW0KMp1l)
