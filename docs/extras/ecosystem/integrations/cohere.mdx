...
See a [usage example](/docs/modules/models/llms/integrations/cohere.ipynb).
...
```
For a more detailed walkthrough of this, see [this notebook](/docs/modules/models/text_embedding/examples/cohere.ipynb)

## Retriever

See a [usage example](/docs/modules/data_io/retrievers/integrations/cohere-reranker.ipynb).
