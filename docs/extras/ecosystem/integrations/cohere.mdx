...
```
For a more detailed walkthrough of this, see [this notebook](/docs/modules/data_io/text_embedding/integrations/cohere.html)

## Retriever

See a [usage example](/docs/modules/data_io/retrievers/integrations/cohere-reranker.html).
