...
For a more detailed walkthrough of the Redis vectorstore wrapper, see [this notebook](/docs/modules/data_io/vectorstores/integrations/redis.ipynb).
...
For a more detailed walkthrough of the `VectorStoreRetrieverMemory` wrapper, see [this notebook](/docs/modules/memory/integrations/vectorstore_retriever_memory.ipynb).

#### Chat Message History Memory
For a detailed example of Redis to cache conversation message history, see [this notebook](/docs/modules/memory/examples/redis_chat_message_history.ipynb).
