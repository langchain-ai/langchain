...
See a [usage example](/docs/modules/models/llms/integrations/sagemaker.ipynb).
...
See a [usage example](/docs/modules/models/text_embedding/examples/sagemaker-endpoint.ipynb).
```python
