...
```
For a more detailed walkthrough of this, see [this notebook](/docs/modules/models/llms/integrations/llamacpp.ipynb)
...
```
For a more detailed walkthrough of this, see [this notebook](/docs/modules/models/text_embedding/examples/llamacpp.ipynb)
