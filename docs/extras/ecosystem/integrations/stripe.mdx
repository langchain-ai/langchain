...
See [setup instructions](/docs/modules/indexes/document_loaders/examples/stripe.ipynb).

## Document Loader

See a [usage example](/docs/modules/indexes/document_loaders/examples/stripe.ipynb).
