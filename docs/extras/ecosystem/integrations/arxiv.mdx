...
See a [usage example](/docs/modules/indexes/document_loaders/examples/arxiv.ipynb).
...
See a [usage example](/docs/modules/indexes/retrievers/examples/arxiv.ipynb).
