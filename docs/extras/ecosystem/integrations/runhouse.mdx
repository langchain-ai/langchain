...
For a more detailed walkthrough of the Self-hosted LLMs, see [this notebook](/docs/modules/models/llms/integrations/runhouse.ipynb)
...
For a more detailed walkthrough of the Self-hosted Embeddings, see [this notebook](/docs/modules/models/text_embedding/examples/self-hosted.ipynb)
