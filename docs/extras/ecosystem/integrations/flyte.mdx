...
To guarantee reproducibility of your pipelines, Flyte [tasks](https://docs.flyte.org/projects/cookbook/en/latest/auto/core/flyte_basics/task.html) are containerized.
...
Please include the following code in `Dockerfile`.
