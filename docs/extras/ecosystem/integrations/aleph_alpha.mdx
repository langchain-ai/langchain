...
See a [usage example](/docs/modules/models/llms/integrations/aleph_alpha.ipynb).
...
See a [usage example](/docs/modules/models/text_embedding/examples/aleph_alpha.ipynb).
