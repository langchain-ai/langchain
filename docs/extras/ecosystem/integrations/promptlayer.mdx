...
PromptLayer also provides native wrappers for [`PromptLayerChatOpenAI`](/docs/modules/models/chat/integrations/promptlayer_chatopenai.ipynb) and `PromptLayerOpenAIChat`
