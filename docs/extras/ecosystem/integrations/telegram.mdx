...
See [setup instructions](/docs/modules/indexes/document_loaders/examples/telegram.ipynb).

## Document Loader

See a [usage example](/docs/modules/indexes/document_loaders/examples/telegram.ipynb).
