...
3. Once you have created a connection, you can use the `PsychicLoader` by following the [example notebook](/docs/modules/indexes/document_loaders/examples/psychic.ipynb)
