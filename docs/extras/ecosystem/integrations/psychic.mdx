...
3. Once you have created a connection, you can use the `PsychicLoader` by following the [example notebook](/docs/modules/data_io/document_loaders/integrations/psychic.html)
