...
See a [usage example for the Azure Blob Storage](/docs/modules/data_io/document_loaders/integrations/azure_blob_storage_container.ipynb).

```python
from langchain.document_loaders import AzureBlobStorageContainerLoader
```

See a [usage example for the Azure Files](/docs/modules/data_io/document_loaders/integrations/azure_blob_storage_file.ipynb).
