...
other text/unstructured data. For this, you should use a document loader like the [CSVLoader](/docs/modules/data_io/document_loaders/how_to/csv.html)
and then you should [create an index](/docs/modules/indexes.rst) over that data, and [query it that way](/docs/modules/chains/popular/vector_db_qa.html).
