...
See [this notebook](/docs/modules/indexes/getting_started.html) for a more detailed introduction to this, but for a super quick start the steps involved are:
...
See [here](/docs/modules/indexes/document_loaders.rst) for more information on how to get started with document loading.
...
Again, these high level interfaces obfuscate a lot of what is going on under the hood, so please see [this notebook](/docs/modules/indexes/getting_started.html) for a lower level walkthrough.
