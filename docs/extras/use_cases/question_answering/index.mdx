...
See [this notebook](../modules/indexes/getting_started.html) for a more detailed introduction to this, but for a super quick start the steps involved are:
...
Again, these high level interfaces obfuscate a lot of what is going on under the hood, so please see [this notebook](../modules/indexes/getting_started.html) for a lower level walkthrough.
...
- [Question Answering Notebook](../modules/chains/index_examples/question_answering.html): A notebook walking through how to accomplish this task.
...
- [QA With Sources Notebook](../modules/chains/index_examples/qa_with_sources.html): A notebook walking through how to accomplish this task.
...
- [Semantic search over a group chat with Sources Notebook](question_answering/semantic-search-over-chat.html): A notebook that semantically searches over a group chat conversation.
