...
See [here](/docs/modules/data_io/document_loaders) for more information on how to get started with document loading.
...
- [Building blocks for working with Documents](/docs/modules/data_io): Guides on how to use several of the utilities which will prove helpful for this task, including Text Splitters (for splitting up long documents) and Embeddings & Vectorstores (useful for the above Vector DB example).
