...
See a [usage example](/docs/modules/model_io/models/llms/integrations/aleph_alpha).
...
See a [usage example](/docs/modules/data_connection/text_embedding/integrations/aleph_alpha).
