...
See a [usage example](/docs/modules/data_connection/document_loaders/integrations/brave_search).
...
See a [usage example](/docs/modules/agents/tools/integrations/brave_search).
