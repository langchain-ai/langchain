...
See a [usage example](/docs/modules/model_io/models/llms/integrations/azure_openai_example).
...
See a [usage example](/docs/modules/data_connection/text_embedding/integrations/azureopenai)
...
See a [usage example](/docs/modules/model_io/models/chat/integrations/azure_chat_openai)
