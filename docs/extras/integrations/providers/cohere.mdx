...
See a [usage example](/docs/modules/model_io/models/llms/integrations/cohere).
...
See a [usage example](/docs/modules/data_connection/retrievers/integrations/cohere-reranker).
