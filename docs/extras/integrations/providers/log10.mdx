...
3. Also add `LOG10_URL=https://log10.io` and your usual LLM API key: for e.g. `OPENAI_API_KEY` or `ANTHROPIC_API_KEY` to your enviornment
...
[More details + screenshots](https://log10.io/docs/logs)
