...
A minimal example of how to run LangChain on Vercel using Flask.

## [FastAPI + Vercel](https://github.com/msoedov/langcorn)

A minimal example of how to run LangChain on Vercel using FastAPI and LangCorn/Uvicorn.

## [Kinsta](https://github.com/kinsta/hello-world-langchain)

A minimal example of how to deploy LangChain to [Kinsta](https://kinsta.com) using Flask.
