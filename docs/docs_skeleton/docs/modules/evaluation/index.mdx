...
Whether or not you are using LangChain's evaluators, various tactics can help debug, measure, and improve your LLM application. The "[How-to](/docs/modules/evaluation/how_to/)" section contains walkthroughs you can reference when solving similar problems, including:
...
- [Pairwise Comparisons](#TODO)

## Examples

Additional examples of how you could use these evaluators for different scenarios and chain implementations in the LangChain library:
