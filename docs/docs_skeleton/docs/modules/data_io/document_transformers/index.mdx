...
import GetStarted from "@snippets/modules/data_io/document_transformers/get_started.mdx"

<GetStarted/>

## Text combiners

Sometimes you have the opposite issue — you have many small pieces of text that you want to combine into larger text inputs.