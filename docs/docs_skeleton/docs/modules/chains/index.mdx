...
- [How-to](./how_to) for walkthroughs of different chain features
- [Foundational](./foundational) to get acquainted with core building block chains
- [Document](./document) to learn how to incorporate documents into chains
- [Popular](./popular) chains for the most common use cases
- [Additional](./additional) to see some of the more advanced chains and integrations that you can use out of the box

![](https://drive.google.com/uc?id=1r56iE1urbbeXQCkRclCxWb8zJp24mkGr)
