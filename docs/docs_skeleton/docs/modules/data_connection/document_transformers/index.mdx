...
## Translate text
Sometimes, it's useful to translate documents into multiple languages before generating embeddings from it, particularly for use cases
...
LangChain uses the [doctran](https://github.com/psychic-api/doctran/tree/main) library to extract properties, which itself depends on [OpenAI function calling](https://openai.com/blog/function-calling-and-other-api-updates).