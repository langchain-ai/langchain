...
- [**Tools**](./tools): The actions an agent can take. What tools you give an agent highly depend on what you want the agent to do
- [**Toolkits**](./toolkits): Wrappers around collections of tools that can be used together a specific use case. For example, in order for an agent to
