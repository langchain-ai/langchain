...
LangChain exposes a standard interface for both, but it's useful to understand this difference in order to be construct prompts for a given language model.
