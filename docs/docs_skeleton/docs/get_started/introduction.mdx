...
We recommend following our [Quickstart](/docs/get_started/quickstart.html) guide to familiarize yourself with the LangChain framework by building and running your first LangChain application.
...
#### [Data connection](/docs/modules/data_io)
