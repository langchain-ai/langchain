...
function getSortedItemsByTitle(dirPath) {
  ...
  return items.map((item) => `templates/${item.file.replace(/\.md?$/, '')}`);
}
  ...
  templates: [
    {
      type: "category",
      label: "Templates",
      items: getSortedItemsByTitle(path.resolve(__dirname, 'templates')),
      link: {
        type: "doc",
        id: "templates/index",
      },
