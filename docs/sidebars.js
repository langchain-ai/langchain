 ...
 */
 ...
 module.exports = {
  ...
  guides: [
    "guides/index",
    { type: "category", label: "Use-cases", collapsible: false, items: [{type: "autogenerated", dirName: "guides/use_cases" }] },
    { type: "category", label: "Expression Language", collapsible: false, items: [{type: "autogenerated", dirName: "guides/expression_language" }] },
    { type: "category", label: "Modules", collapsible: false, items: [{type: "autogenerated", dirName: "guides/modules" }] },
