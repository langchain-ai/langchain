...
def test_add_messages(file_chat_message_history):
...
def test_clear_messages(file_chat_message_history):
    file_chat_message_history.add_user_message("Hello!")
    file_chat_message_history.add_ai_message("Hi there!")
...
def test_multiple_sessions(file_chat_message_history):
    # First session
