...
from langchain.agents.reflexion.react import ReactReflector, ReactReflexionOutputParser
...
def test_should_continue() -> None:
    ...
    non_repeating_actions = [
        ...
        AgentAction(tool="SecondTestTool", tool_input="test input", log="I did it!")
    ]
    repeating_actions = [
        AgentAction(tool="FirstTestTool", tool_input="test input", log="I did it!"),
        AgentAction(tool="SecondTestTool", tool_input="test input", log="I did it!"),
