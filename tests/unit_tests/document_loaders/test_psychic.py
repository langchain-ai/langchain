...
class TestPsychicLoader:
    ...
    def test_psychic_loader_initialization(self, mock_psychic: MagicMock, mock_connector_id: MagicMock) -> None:
        PsychicLoader(
        ...
        mock_psychic.assert_called_once_with(
    ...
    def _get_mock_psychic_loader(
        self, mock_psychic: MagicMock
    ) -> PsychicLoader:
