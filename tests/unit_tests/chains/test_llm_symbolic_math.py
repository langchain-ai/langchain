...
def fake_llm_symbolic_math_chain() -> LLMSymbolicMathChain:
    ...
    queries = {
        ...
        _PROMPT_TEMPLATE.format(question="What is the square root of 2?"): "```text\nsqrt(2)\n```",
...
def test_integration_question(fake_llm_symbolic_math_chain: LLMSymbolicMathChain) -> None:
